    ...
    <div class="chekout p-4 shadow my-4">
      ...
      <div class="row justify-content-between">
        <div class="justify-content-end tex-end">
          <div v-if="otherData.type && packageType == 'academy'" style="display: flex; align-items: center;">
            ...
            <div class="mx-3" style="color: #1FB9B3; display: flex;" >
              ...
              <h4 class="mx-2"  style="color: #1FB9B3">انضم الى الأكاديمية</h4>
               ...
               <div v-else-if="otherData.type && packageType == 'network'" style="display: flex; align-items: center;">
                ...
                <div v-else-if="otherData.type && packageType == 'service-provider'" style="display: flex; align-items: center;">
