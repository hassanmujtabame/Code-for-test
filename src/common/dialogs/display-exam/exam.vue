    ...
    <div class="container">
            ...
            <div class="do-exam__wrapper">
                ...
                <div class="do-exam__body">
                    <div v-for="(q, i) in questions" :key="i">
                        <showQuestion @update="updateResponse" :item="q" v-if="(i + 1) == step" />
                    </div>
        ...
        {{ responses.map(x=>x.value) }}
                ...
                <div class="do-exam__footer">
                    ...
                    <button :disabled="step >= questions.length" @click="nextStep"
                        class="btn btn-custmer btn-small mx-3">التالى</button>
                </div>
            </div>
        </div>
