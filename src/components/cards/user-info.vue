<template>
    <div class=" my-profile box info border p-3 bg-card" v-bind="$attrs">
        <div class="main-img text-center m-auto avatar-user-card clickable" @click="showProfile"
        ...
        <div class=" text-center">
            <div class="message-service">
                <button class="text-white border-0 p-2 px-3" v-if="showBtnMsg" @click="sendMessage">
                ...
                <button v-if="showBtnChat" @click="openChat" class="text-white border-0 p-2 px-3 mx-2"><i
