    ...
    <div class="d-flex">
      ...
      <div class="text-start px-3">
        ...
        <button @click="copyToClipboard" class="btn border p-2  px-3 coupon-card__code">
          <svg class="coupon-card__code-icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <path
              ...
              fill="#1FB9B3" />
            <path
              d="M16.9977 14.1505H13.7977C10.9877 14.1505 9.84766 13.0105 9.84766 10.2005V7.00048C9.84766 6.70048 10.0277 6.42048 10.3077 6.31048C10.5877 6.19048 10.9077 6.26048 11.1277 6.47048L17.5277 12.8705C17.7377 13.0805 17.8077 13.4105 17.6877 13.6905C17.5777 13.9705 17.2977 14.1505 16.9977 14.1505ZM11.3477 8.81048V10.2005C11.3477 12.1905 11.8077 12.6505 13.7977 12.6505H15.1877L11.3477 8.81048Z"
              fill="#1FB9B3" />
            <path
            ...
            <path
              ...
              fill="#1FB9B3" />
            <path
              d="M19.1875 17.75C18.7775 17.75 18.4375 17.41 18.4375 17C18.4375 16.59 18.7775 16.25 19.1875 16.25C20.3275 16.25 21.2475 15.32 21.2475 14.19V8C21.2475 7.59 21.5875 7.25 21.9975 7.25C22.4075 7.25 22.7475 7.59 22.7475 8V14.19C22.7475 16.15 21.1475 17.75 19.1875 17.75Z"
              fill="#1FB9B3" />
            <path
      ...
      <p class="t-c p-0 m-0 ">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill="#979797" />
          <path
            d="M8 9.16536C7.72667 9.16536 7.5 8.9387 7.5 8.66536V5.33203C7.5 5.0587 7.72667 4.83203 8 4.83203C8.27333 4.83203 8.5 5.0587 8.5 5.33203V8.66536C8.5 8.9387 8.27333 9.16536 8 9.16536Z"
            fill="#979797" />
          <path
...
.coupon-card__code-text,
.coupon-card__code-icon {
  font-weight: 500;
  font-size: 16px;
  line-height: 17px;
  color: #1FB9B3;
