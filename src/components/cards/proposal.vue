...
<div style="border-bottom: 1px solid #E8EFF0" class="my-1 pb-3">
                ...
                <div class="t-c"> 
                        <div class="d-flex justify-content-between mb-3" style="align-items:baseline!important;">
                        <h5>{{ title ?? 'N/A' }}</h5>
                        <span class="rounded-3 text-white" style="padding: 4px 12px"  :class="[ state == 'offline' ? 'bg-off' : 'bg-on' ]">
                ...
                <p class="t-c fs-r-12 mb-0">
                        <!--timer-->
                        <TimerIcon/>
                        <template >{{ $t('ends-yet') }} {{ executionTime}} {{ $t('day_s') }}</template>
