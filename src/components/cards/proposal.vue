<template>
    <div class="box p-3 rounded-3 proposal-card" style="box-shadow:5px 10px 18px #888888; margin-bottom:20px">
        <div class="d-flex ">
                ...
                <div class="d-flex gap-2 mt-3" style="align-items: flex-start;">
                    ...
                    <div v-if="images">
                        <div class="d-flex gap-3 flex-wrap flex-shrink-0">
                            <a v-for="item, i in images" :key="i" style="text-decoration: revert;" class="t-c" href>Image
                                {{ i + 1 }} </a>
                        </div>

                    </div>
                    <img v-b-modal="`my-modal-${id}`" style="margin-right: auto;"
