    ...
    <div class="provider-card">
        <div class="provider-card__wrapper relative">
            <div class="provider-card__image parent">
                <router-link v-if="to" :to="to">
                    ...
                    <!-- <div
                        ...
                        "
                    ></div> -->
                    <img style="border-radius: 10px" @click="$emit('click-image')" :src="img" alt width="100%" height="100%" class="image1" />
            ...
            <div class="provider-card__content py-0" style="">
                ...
                <div class="d-flex px-2 justify-content-center align-items-center " style="width: 100%">
                    <div class="provider-card__description t-c">{{ description }}</div>
...
.provider-card__wrapper:hover {
    box-shadow: 0 1px 3px 4px rgb(0 0 0 / 0.1),
        0 1px 2px -1px rgb(0 0 0 / 0.1);
}
