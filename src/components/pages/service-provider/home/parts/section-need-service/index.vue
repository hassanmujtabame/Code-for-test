<template>
  <div class="main-top py-2 px-5 position-relative">
    <div class="row align-items-center m-auto">
      <div class="box py-3  m-auto text-cover mobile-center">
        <h1 class="text-white">محتاج خدمة ؟ تبحث عن موظف مميز ؟</h1>
        <p
          class="text-white"
        >أشترك الان في منصة شبكة رياديات لتستطيع شراء خدمات من منصة مقدمي خدمات رياديــــــات كما انك تستطيع اضافة طلب خاص ليقوم مقدمي الخدمات بالتواصل معك و تلبيه طلبـك بالاضافة الى امكانية توظيف خريجين منصات رياديات معك في شركتك .</p>
        <p class="fw-bolder">ليس هذا وحسب فشبكة رياديات بها العديد من المميزات الاخرى :</p>
        <router-link
