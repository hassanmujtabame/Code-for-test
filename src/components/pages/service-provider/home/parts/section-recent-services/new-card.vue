<template>
    <router-link style="color: inherit;" :to="getRouteLocale('service-provider-ready-service', { id: id })">
        <div class="card-container d-flex flex-column justify-content-between">
            ...
            <div>
                <div style="display: flex;
                    align-items: center;
                    gap: 15px;">
                    <ShowTime :dateTime="created_at" style="
                    color: var(--Teal-Primary, #1FB9B3);font-size: 12px;" />
                    <svg xmlns="http://www.w3.org/2000/svg" width="179" height="2" viewBox="0 0 179 2" fill="none">
                        <line x1="0.65" y1="1.35" x2="178.35" y2="1.35001" stroke="white" stroke-width="1.3"
                ...
                <div style="margin-top: 10px; display: flex;align-items: center;justify-content: space-between">
                    ...
                    align-items: center;
                    gap: 10px;">
                            <img style="width: 50px; height: 50px; border-radius: 10px" :src="image" alt="">
                    </div>
                </div>
            </div>
        </div>
...
.card-container {
    ...
    height: 332px;
    border-radius: 16px;
    background: rgba(31, 185, 179, 0.20);
    padding: 10px;
}
</style>
