<template>
  <div class="box rounded-top mb-3">
    <div class="parent">
      <img v-if="image" class="w-100 image1" :src="image" :alt="title" height="264px" />
...
<!-- <div class="px-3">{{name.name}}</div> -->
      ...
      <h5 style="color:#ebae05;" class="py-3"> شارك {{ title ?? 'N/A' }} على مواقع التواصل الاجتماعي</h5>
