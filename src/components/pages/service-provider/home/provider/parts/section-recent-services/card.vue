<template>
    <div class="box rounded-top mb-3">
        <div class="parent">
            ...
            <div v-b-modal="`my-modal-${id}`" class="image2 bg-white" style="
                    border-radius: 100%;
                    width: 35px;
                    height: 35px;
                    display: flex;
        ...
        <router-link class="router-link" :to="getRouteLocale('service-provider-ready-service', { id: id })">
            <div class="p-3">
                <h6 class="m-c">{{ title ?? 'N/A' }}</h6>
                <p v-if="description && description.length > 0" class="text-two-lines txt-description" v-html="description">
                </p>
                ...
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div v-if="name && name != null" class="d-flex align-items-center">
                        <div>
                            <img class="" style="border-radius: 100%" :src="name.image" height="40px" width="40px" />
                        </div>
