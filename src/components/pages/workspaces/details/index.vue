  ...
  <div style="margin-top: 85px">
    ...
    <div v-else class="container">
      <div class="row justify-content-between">
        <div class="col-md-6">
          <h3>
            <span class="m-c"> خدمة جاهزة : </span>
            تصميم ازياء
          </h3>
        </div>
          ...
          <div>
            ...
            <div class="dropdown">
              <button
                ...
                class="btn border-0 text-white dropdown-toggle"
                type="button"
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" @click="openChangePriceDialog"
                    >تعديل قيمة الصفقة</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" @click="openChangeDateDeliveryDialog"
                    >تعديل موعد التسليم</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" @click="openConfirmFinishDialog">
                    حذف و أنهاء المشروع</a
                  >
                </li>
              </ul>
            </div>
        ...
        <div class="row redy-services">
          ...
          <div class="col-md-6 mt-5">
            ...
            <div
              style="background-color: #fff3e5"
              class="box p-5 text-center mt-3 rounded-3"
            >
              <div>
                <svg
                  width="141"
              ...
              <div class="mt-3">
                <h6 style="color: #f2631c" class="text-start">تنبيه هام :</h6>
                <p class="text-start">
                  ممكن نكتب هنا اهم التنببيهات الاساسية لمقدم الخدمة زي متتوصلش
                  برا رياديات علشان حسابك ميقفش و تحجز مستحقاتك واشياء من هذا
                  القبيل
                </p>
              </div>
            </div>
