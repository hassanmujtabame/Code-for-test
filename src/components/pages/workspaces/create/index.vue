          ...
          <div class="mb-3">
            ...
            >
              ...
              >
                ...
                <option
                  :key="i"
                  v-for="(option, i) in providerCategories"
                  :value="option.name"
                >
                  {{ option.name }}
                </option>
                ...
                >
                  <b-card-body>
                    <b-card-text class="d-flex flex-wrap">
                      <div
                        v-for="(item, i) in featuresWorkSpace"
                        :key="i"
                        style="width: 30%"
                      >
                        <div
  ...
  methods: {
    async addWorkSpace() {
      ...
      if (!valid) {
        ...
        console.log(`catefory ${this.form.category}`);
        console.log(`start time ${this.form.start_time}`);
        console.log(`end time ${this.form.end_time}`);
        console.log(`service category ${this.form.service_categories_ids}`);
        console.log(`city id ${this.form.city_id}`);
        console.log(`features ${this.form.features}`);
        console.log(`location ${this.form.location}`);
        console.log(`price ${this.form.price}`);
        console.log(`people ${this.form.number_peoples}`);
        console.log(`des ${this.form.description}`);
