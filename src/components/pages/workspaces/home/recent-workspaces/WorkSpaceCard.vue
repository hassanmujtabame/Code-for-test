    ...
    <div class="workspace-card__wrapper">
      ...
      <div class="workspace-card__footer" style="height: 55px">
        <div class="workspace-card__footer-item flex-grow-1">
          ...
          <span
            v-if="company.map_address && company.map_address.address_name"
            >{{ company.map_address.address_name }}</span
          >
        </div>
        <div
          class="workspace-card__footer-item flex-shrink-0 align-items-center"
        >
      ...
      <div class="d-flex align-items-center justify-content-between px-3 pb-3">
        <router-link class="router-link" :to="to" style="width: 100px">
          <button
            class="btn btn-main"
            style="width: 100px; height: 30px; font-size: 12px; padding: 5px"
          >
            عرض التفاصيل
          </button>
        </router-link>
        ...
        <div class="d-flex align-items-center">
          <span class="px-1" style="font-size: 15px; color: #414042">{{
            rate
          }}</span>
        </div>
        <!--  star icon  -->
