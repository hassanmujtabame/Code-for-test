  ...
  <div class="p-0 m-0 sec-one" style="background: #fff">
    <div class="container" style="position:relative" :class="[isMobile ? 'p-3' : '']">
      <div class="row pb-5">
        ...
        <div v-if="!isMobile" style="position: relative " class="col-8 d-flex justify-content-end">
          <img style="  height: auto;
            object-fit: contain;width: 250px;" class="img-fluid" src="@/assets/img/new/main-page/header/Student.png"
            alt="home-section-background" />

          <span class="p-2" style="background: #607D8B;
              height: fit-content;
              color: #fff;
          ...
          <span v-if="showSecondText" class="p-2" style="background: #607D8B;
            height: fit-content;
            color: #fff;
            border-radius: 10px 10px 0px 10px;
            position: absolute;
            top: 150px;right: 600px;
            width:max-content;
            ">
            {{ animatedSecondText }}
          </span>
          <span v-if="showThirdText" class="p-2" style="background: #2196F3;
            height: fit-content;
            color: #fff;
            border-radius: 10px 10px 10px 0px;
            position: absolute;
            top: 220px;right: 600px;
            width:max-content;
            ">
            {{ animatedThirdText }}
          </span>
          <span v-if="showFourthText" class="p-2" style="background: #2196F3;
          height: fit-content;
          color: #fff;
          border-radius: 10px 10px 10px 0px;
          position: absolute;
          top: 270px;right: 540px;
          width:max-content;
          ">
            {{ animatedFourthText }}
          </span>
          ...
          <img style="  height: auto;
          object-fit: contain;width: 250px; transform: translate(-150px, 200px);" class="img-fluid"
            src="@/assets/img/new/main-page/header/Teacher.png" alt="home-section-background" />
          <!-- <img style="  height: auto;
          object-fit: contain;width: 75%;" class="img-fluid" src="@/assets/img/new/main-page/header/Icons.png"
            alt="home-section-background" /> -->
        </div>
      </div>
    </div>
    <div id="text-container">{{ animatedText }}</div>
