<template>
	<svg :fill="color" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
		xmlns:xlink="http://www.w3.org/1999/xlink" :width="size" :height="size" viewBox="0 0 47 47" xml:space="preserve">
		<g>
			<g id="Layer_1_110_">
				<g>
					<path :stroke="stroke" d="M17.567,15.938l-2.859-2.702c0.333-0.605,0.539-1.29,0.539-2.029c0-2.342-1.897-4.239-4.24-4.239
				...
				C16.536,16.922,17.023,16.399,17.567,15.938z" />
					<path :stroke="stroke" d="M29.66,15.6l3.799-6.393c0.374,0.107,0.762,0.184,1.169,0.184c2.347,0,4.244-1.898,4.244-4.241
				...
				C28.48,14.801,29.094,15.169,29.66,15.6z" />
					<path :stroke="stroke" d="M42.762,20.952c-1.824,0-3.369,1.159-3.968,2.775l-5.278-0.521c0,0.04,0.006,0.078,0.006,0.117
				...
				C47,22.85,45.104,20.952,42.762,20.952z" />
					<path :stroke="stroke" d="M28.197,37.624l-1.18-5.156c-0.666,0.232-1.359,0.398-2.082,0.481l1.182,5.157c-1.355,0.709-2.29,2.11-2.29,3.746
				c0,2.342,1.896,4.237,4.243,4.237c2.342,0,4.238-1.896,4.238-4.237C32.311,39.553,30.479,37.692,28.197,37.624z" />
					<path :stroke="stroke" d="M14.357,25.37l-6.57,2.201c-0.758-1.158-2.063-1.926-3.548-1.926C1.896,25.645,0,27.542,0,29.884
