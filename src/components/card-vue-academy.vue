              ...
              <defs>
                <clipPath id="clip0_5133_37372">
                  <rect
                    ...
                    height="56"
                    fill="white"
                    transform="translate(0.800781 0.443359)"
                  />
                </clipPath>
              </defs>
            </svg>

            <component v-else :is="`${icon}-icon`" />
