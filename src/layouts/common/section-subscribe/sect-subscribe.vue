  ...
  <div class="sec-subscripe mt-5">
        <div class="container">
          <div class="row align-items-center justify-content-center " :class="{'p-4':!isMobile,'py-4':isMobile}">
            ...
            <div class="col-md-6">
              <div class="input-group input-group-lg  m-auto"  :class="{'w-75':!isMobile,'w-100':isMobile}">
                ...
                <span class="input-group-text bg-yal text-white" :class="{'fs-6':isMobile}" id="inputGroup-sizing-lg">{{ $t('Subscribe') }}</span>
              </div>
            </div>
          </div>
        </div>
