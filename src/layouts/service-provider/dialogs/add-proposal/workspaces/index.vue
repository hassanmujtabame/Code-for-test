<template>
  <div class="recent-work-spaces p-2 my-5">
    <div class="container-fluid">
      ...
      >
        ...
        <template v-slot:default="{ item }" >
            <button class="btn-main-v" style="position:absolute; top:7px; background: #ffbe39ff !important; border: none; padding: 3px 5px" role="button" @click="rescheduleRequest(item)">احجز الآن</button>
            <WorkSpaceCard
                :title="item.title"
                :medias="item.medias"
