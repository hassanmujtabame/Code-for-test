<template>
    <TemplateDrawer dashboard="affiliate-marketing-dashboard" v-slot="{ clickLink }">

        <div class="box  mx-2 mt-3 ">
            <d-user-rect-icon class="m-c" color="currentColor" />
            <router-link custom v-slot="{ navigate }" :to="getRouteLocale('affiliate-marketing-my-profile')"
                class="mx-2 m-c ">
        ...
        <div class="box  mx-2 mt-3 ">
            <d-affiliate-marketing-business-icon class="m-c" color="currentColor" />
            <router-link custom v-slot="{ navigate }" :to="getRouteLocale('affiliate-marketing-affiliate-marketing-business')"
                class="mx-2 m-c ">
                <button @click="clickLink(navigate, $event)" role="link" class="btn-drawer"> {{
                    $t('affiliate-marketing-stages') }}</button>
            </router-link>
        </div>
        <div class="box  mx-2 mt-3 ">
            <paperclip-icon class="m-c" color="currentColor" />
            <router-link custom v-slot="{ navigate }" :to="getRouteLocale('affiliate-marketing-your-courses')"
                class="mx-2 m-c ">
        ...
        <div class="box  mx-2 mt-3 ">
            ...
            <router-link custom v-slot="{ navigate }" :to="getRouteLocale('affiliate-marketing-menu-subscribe')"
                class="mx-2 m-c ">
        ...
        <div class="box  mx-2 mt-3 ">
            ...
            <router-link custom v-slot="{ navigate }" :to="getRouteLocale('affiliate-marketing-my-financial-transactions')"
                class="mx-2 m-c ">
                <button @click="clickLink(navigate, $event)" role="link" class="btn-drawer">{{
        ...
        <div class="box  mx-2 mt-3 ">
            ...
            <router-link custom v-slot="{ navigate }" :to="getRouteLocale('affiliate-marketing-preview-profile')"
                class="mx-2 m-c ">
