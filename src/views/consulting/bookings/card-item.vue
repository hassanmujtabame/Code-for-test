...
export default {
  ...
  computed: {
    ...
    desc() {
      return "تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة  تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة  تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة تفاصيل تتم اضافتها من قبل العميل طالب الخدمة ";
