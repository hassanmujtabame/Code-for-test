            ...
            <div class="box bg-white  p-3  rounded-3">
                ...
                <div class="row align-items-start ">
                    <div class="col-md-6">
                        ...
                        <p>
                            بمجرد تسجيلك فأنت توافق على <a href="" class="m-c">الشروط والاحكام</a>.

                        </p>
                        <ValidationObserver ref="form">
                            <template v-if="!user">
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('name')" rules="required"
                                        vid="name" v-slot="{ errors }">


                                        <d-text-input type="text" :errors="errors" v-model="itemForm.name"
                                            class="form-control" id="validationCustom03" :label="$t('name')" />

                                    </ValidationProvider>
                                </div>

                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('email')" rules="required"
                                        vid="email" v-slot="{ errors }">
                                ...
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('phone-number')"
                                        rules="required|numeric" vid="phone" v-slot="{ errors }">
                                        <d-text-input :errors="errors" type="number" v-model="itemForm.phone"
                                            class="form-control" :label="$t('phone-number')">
                                        </d-text-input>
                                ...
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('password')" rules="required"
                                        vid="password" v-slot="{ errors }">
                                        <d-text-input :errors="errors" id="password-register"
                                            :type="show ? 'text' : 'password'" class="form-control  "
                                            v-model="form.password" :label="$t('Password')" autocomplete="new-password">
                                ...
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('password-confirmation')"
                                        rules="required" vid="password_confirmation" v-slot="{ errors }">
                                        <d-text-input :errors="errors" id="password-register-confirm"
                                            :type="showC ? 'text' : 'password'" class="form-control  "
                                            v-model="form.passwordConfirm" :label="$t('Password-confirm')">
                                            <template v-slot:append-icon>
                                                <span style="color: #CDD7D8;font-size: 23px;" @click="show = !show"
                                                    class="fa-regular mx-1"
                                                    :class="{ 'fa-eye': !show, 'fa-eye-slash': show }">
                                ...
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('identity-id')"
                                        rules="required|numeric" vid="identity_id" v-slot="{ errors }">

                                        <d-text-input :errors="errors" type="text" :label="$t('identity-id')"
                                            v-model="itemForm.identity_id" class="form-control">
                                        </d-text-input>
                                    </ValidationProvider>
                                </div>
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('gender')" rules="required"
                                        vid="gender" v-slot="{ errors }">
                                        <div class="form-group">

                                            <d-select-input :errors="errors" v-model="itemForm.gender"
                                                :label="$t('gender')">
                                ...
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('birthday')" rules="required"
                                        vid="birthday" v-slot="{ errors }">
                                        <div class="form-group">

                                            <label class="form-label">{{ $t('birthday') }} </label>
                                            <div class="w-100 position-relative">
                                                <vc-date-picker v-model="itemForm.birthday" mode="date" is24hr
                                                    :modelConfig="modelConfig">
                                                    <template v-slot="{ inputValue, togglePopover, inputEvents }">
                                                        <input readonly type="text" :value="inputValue" v-on="inputEvents"
                                                            class="form-control px-3">
                                                        <svg @click="togglePopover" style="top: 6px;left: 6px;"
                                                            class="position-absolute clickable" width="24" height="24"
                                ...
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('Country')" rules="required"
                                        vid="country_id" v-slot="{ errors }">

                                        <d-select-input :errors="errors" v-model="itemForm.country_id"
                                            :label="$t('Country')">
                                            <option selected disabled>الدولة</option>
                                            <option v-for="(country, i) in countries" :key="i" :value="country.id">{{
                                                country.name }}</option>
                                        </d-select-input>
                                    </ValidationProvider>
                                </div>
                                <div class="col-md-4 w-100 mt-2">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('city')" rules="required"
                                        vid="city_id" v-slot="{ errors }"><label class="form-label">{{ }}</label>
                                        <select :errors="errors" v-model="itemForm.city_id" :label="$t('city')">
                                            <option selected disabled>المدينة</option>
                                            <option v-for="(city, i) in cities" :key="i" :value="city.id">{{ city.name }}
                                            </option>
                                        </select>
                                    </ValidationProvider>
                                </div>
                            ...
                            <div class="col-md-4 w-100 mt-2">
                                <ValidationProvider tag="div" class="w-100" :name="$t('Specialization')" rules="required"
                                    vid="department_id" v-slot="{ errors }">
                            ...
                            <div class="col-md-4 w-100 mt-2">
                                <ValidationProvider tag="div" class="w-100" :name="$t('job-position')" rules="required"
                                    vid="job_title" v-slot="{ errors }">

                                    <d-text-input :errors="errors" v-model="itemForm.job_title" type="text"
                                        :label="$t('job-position')" class="form-control">
                                    </d-text-input>
                            ...
                            <div class="col-md-4 w-100 mt-2">
                                <ValidationProvider tag="div" class="w-100" :name="$t('about-you')" rules="required"
                                    vid="bio" v-slot="{ errors }">

                                    <d-textarea-input :errors="errors" v-model="itemForm.bio" class="form-control" rows="5"
                                        :label="$t('about-you')"></d-textarea-input>

                                </ValidationProvider>
                            </div>
                            <div class="col-md-4 w-100 mt-2">
                                <ValidationProvider tag="div" class="w-100" :name="$t('attachment')"
                                    rules="required|ext:pdf" vid="cv" v-slot="{ errors, validate }">
                                    <div class="form-group">

                                        <label class="w-100 position-relative border rounded-2">
                                            <input type="file" @change="uploadFile($event, validate) || validate($event)"
                                                class="form-control opacity-0 " required>
                                            <svg style="top: 6px;left: 6px;" class="position-absolute" width="24"
                            ...
                            <div class="col-md-4 w-100 mt-2">
                                ...
                                <div class="form-check ">
                                    <ValidationProvider tag="div" class="w-100" :name="$t('terms_use')" rules="required"
                                        vid="terms_use" v-slot="{ errors }">
                                        <div class="form-group">

                                            <input :value="itemForm.terms_use"
                                                @input="event => itemForm.terms_use = event.target.checked === true ? true : null"
