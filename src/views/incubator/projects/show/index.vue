                ...
                <div class="col-12  ">
                    ...
                    <div class="row  justify-content-between">
                        <div class="col-12 col-md-3 border rounded py-3">
                            ...
                            <p class="incubator-project__place text-center">
                                <i class="fa fa-location-dot"></i> 
                                السعوديه - الرياض
                                <!-- this gives null uncommit after ending the backend error -->
                                <!-- {{itemPage.city_name }} -->
                            </p>
                            <div class="d-flex gap-3 justify-content-center">
                                ...
                                <ShareNetwork network="facebook" :url="shareLink" title="Share in Instagram"
                                    description="This is another awesome article for awesome readers">
