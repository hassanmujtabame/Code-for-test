               ...
               <div class="row align-items-center px-5 m-auto">
                <div class="col-12 col-md-6 mt-3">
                  ...
                  <div style="margin-top: 20px;" class="">
                    ...
                    <router-link  :to="getRouteLocale('incubator-contact-us-for-project')" role="link" class="btn border p-2 text-white bg-transpernt svg-network ">
