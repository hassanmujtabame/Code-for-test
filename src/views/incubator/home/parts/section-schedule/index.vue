  ...
  <div class="container">
    <div class="section-schedule">
      ...
      <p class="home-section-text">
        {{ $t("riadiat-incubator-schedule-text") }}
      </p>
      ...
      <div class="section-schedule-content">
        <div class="row p-2">
          <div class="col-md-8 col-12">
            <div class="row">
              <div
                v-for="(item, i) in items.filter((x, i) => i < 3)"
                :key="i"
              ...
              >
                <router-link
                  class="router-link"
                  :to="
                    getRouteLocale('network-learning-meeting-show', {
                      id: item.id,
                    })
                  "
                >
...
export default {
  ...
  methods: {
    dayclick(day) {
      if (process.env.NODE_ENV !== "production") console.log("day", day);
    },
    async loadList() {
      this.loading = true;
      try {
