<template>
            ...
            <div class="box bg-white border p-5 shadow">
                ...
                <h2>
                    ...
                    <button type="button"  class="y-c border-0 bg-transparent" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                         {{subscribeType}}
                    </button>
                ...
                <div class=" pt-4">
                    ...
                    <router-link :to="getRouteLocale('service-provider-home')" class="btn-custmer-w fw-bolder">
                    ...
                    <div  class="sec-tow">
                        <div class=" ">
                            ...
                            >
                              ...
                              <div class=" col-md-6 p-4">
                                ...
                                <div>
                                  ...
                                  <router-link :to="getRouteLocale('academy-subscribe')" class="btn-custmer">
                                    أنضمي الينا الان
                                  </router-link>
                                </div>
                              </div>
                          ...
                          >
                            ...
                            <div class=" col-md-6 p-4">
                              ...
                              <div>
                                ...
                                <router-link :to="getRouteLocale('incubator-subscribe')" class="btn-custmer">
                                    أنضمي الينا الان
                                  </router-link>
                              </div>
                            </div>
                          ...
                          >
                            ...
                            <div class=" col-md-6 p-4">
                              <h3 class="p-c">تعرف على مقدمي الخدمة </h3>
                              <p class="p-c">
                              ...
                              <div>
                                  ...
                                  <router-link :to="getRouteLocale('service-provider-subscribe')" class="btn-custmer">
                                    أنضمي الينا الان
                                  </router-link>
                              </div>
                            </div>
...
export default {
  ...
  data:(vm)=>{
    let type ='N/A';
    switch (vm.pack.type) {
      case 'free': type = vm.$t('free_package'); break;
      case 'month': type = vm.$t('monthly_package'); break;
      case 'year': type = vm.$t('annual_package'); break;
