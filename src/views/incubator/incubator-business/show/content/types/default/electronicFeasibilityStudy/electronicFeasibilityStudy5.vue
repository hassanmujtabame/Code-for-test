<template>
    ...
    <tr>
     ...
     <tr>
      ...
      <td><input/> </td>
        ...
        <p class="t-c">يساعدك هذا النموذج على مقارنة وضع مشروعك في السوق مع منافسيك، يمكنك زيادة عدد المنافسين حسب مشروعك.</p>
     <table class="col-12">
  <thead>
    <tr>
      <th>المنافس</th>
  ...
  <tbody >
     <tr>
      <td style="background:rgba(227, 241, 241, 1); color: rgba(15, 119, 116, 1)">المبادرات المبنية على مواطن الضعف الداخلية والتهديدات الخارجية </td>
      <td style="background:rgba(227, 241, 241, 1); color: rgba(15, 119, 116, 1)">المبادرات المبنية مواطن القوة الداخلية والتهديدات الخارجية</td>
       <td style="background:rgba(227, 241, 241, 1); color: rgba(15, 119, 116, 1)">المبادرات المبنية على مواطن الضعف الداخلية والفرص الخارجية </td>
      <td style="background:rgba(227, 241, 241, 1); color: rgba(15, 119, 116, 1)">المبادرات المبنية على مواطن القوة الداخلية والفرص الخارجية </td>
  ...
  <div class="mt-3">
	...
	<div class="col-md-12">
                            <label style="border: 0px !important;" for="imginput" class="img-zone form-label file-label first w-100">
                                  ...
                                  <img :src="`${publicPath}assets/svg/Group 11712759838.svg`"  />
  ...
  <div class="mt-3"> 
		...
		<input
                class="form-control py-3 px-5 fs-r-12"
                type="text"
                placeholder="هل المشروع صناعي أو تجاري أو مهني"
              />
		</div>
    <div class="mt-3"> 
