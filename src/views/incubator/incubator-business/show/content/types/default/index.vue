  ...
  <div class="">
    ...
    <div v-if="phase.file">
      <h1 class="incubator-business-content__title pb-0 mb-3">
        ...
        {{ phase.title }}
        <!-- <p class="incubator-business-content__desc">  </p> -->
      </h1>


      <div class="col-12 col-md-4">
        <router-link class="router-link" :to="getRouteLocale('network-model-show', { id: phase.id })">
          <ModelCard :title="phase.title" :img="phase.image" :value="phase.count_download" />
        </router-link>
      </div>

      <button class="col-md-4 btn bg-main p-2 px-4 text-white mt-3" @click="downloadingModel">
      ...
      <div class="student-course box border" style="width:260px">
        <div class="student-course__image">
          ...
          <router-link class="router-link" :to="getRouteLocale('academy-course-show', { id: phase.id })">
            ...
            <img class="w-100 rounded-top" :src="phase.image_path" height="100%">
            <!-- </router-link> -->
          </router-link>
