    ...
    <div>
      <p>تصنيف المشروع</p>
		...
		<input
                class="form-control py-3 px-5 fs-r-12"
                type="text"
                placeholder="هل المشروع جديد أو توسعة أو إعادة تأهيل؟"
              />
		</div>
  ...
  <tbody >
    <tr>
      ...
      <td><input/> </td>
         ...
         <tr>
      <td>8- التشغيل التجريبي وتشغيل العاملين</td>
      <td><input/> </td>
      <td><input/> </td>
      <td><input/> </td>
    </tr>
      <tr>
      <td>9- بداية الانتاج</td>
      <td><input/> </td>
      <td><input/> </td>
      <td><input/> </td>
    </tr>
...
<div class="mt-3">
  <p>اختيار الموقع المقترح: (يتم الاستغناء عن تعبئة البيانات المتعلقة بالموقع في حال كان مكان المشروع هو المنزل أو تطبيق أو موقع الكتروني)</p>
</div>

         <div class="mt-3 col-12">
  <p>مرحلة التصفية الأولى: (ذكر على الأقل 5 مواقع للمقارنة بينهم من حيث النقاط الموضحة بالجدول من خلال كتابة الأرقام من 1 إلى 5)5 ممتاز، 4 جيد جداً، 3 جيد، 2 مقبول، 1ضعيف</p>
