<template>
  <div class="container">
    ...
    <div class="mt-3">
      <p>اسم المشروع:</p>
      <input class="form-control py-3 px-5 fs-r-12" type="text" placeholder="اكتب اسم مشروعك هنا" />
    </div>
    <div class="mt-3">
      <p> شعار المشروع</p>
    ...
    <div class="mt-3 col-12">
      <p> منهجية دراسة الجدوى</p>
      <input class="form-control py-3 px-5 fs-r-12" type="text"
        placeholder="على ماذا تم الاعتماد في الدراسة؟ على منهج الوصف التحليلي أو جمع المعلومات من مصادرها الأولية مثل نشر استبانة أو من الخبراء" />
    </div>
    <div class="mt-3 col-12">
      <div class="t-c">
        <p>الأهداف: (على صاحب المشروع أن يحدد أهدافه وتصوراته الشخصية للقيام بالمشروع)</p>
        <p>1. أهداف شخصية مثل:</p>
        <p>الابتكار: (وسيلة لعمل شي يحمل بصمة المشروع مثل منتج مبتكر أو خدمة جديدة أو ابتكار طريقة جديدة لإدارة المبيعات
          أو التعامل مع العملاء وغيرها)</p>
      </div>
    </div>
    ...
    <p class="mt-3 t-c">أهداف مالية: (كسب مزيد من المال وتسخيره لتوسيع المشروع وتطويره)</p>
    <div class="mt-3 col-12">
      <p>الأهداف المالية</p>
      <input class="form-control py-3 px-5 fs-r-12" type="text" />
    </div>
    <p class="mt-3 t-c">شخصية صاحب المشروع: (تلعب الشخصية دور مهم في نجاح المشروع مثل – الخبرات والمهارات التي تخدم مشروعه
      في مهارات الاتصال، التصميم، الإشراف، التنظيم، التسويق وغيرها). ما هي الجوانب المهمة من شخصية صاحب المشروع قبل البدء
      في تنفيذ المشروع؟</p>

    <div class="mt-3 col-12">
      <p>شخصية صاحب المشروع</p>
      <input class="form-control py-3 px-5 fs-r-12" type="text" />
    </div>
    <div class="mt-3 col-12">
      <p>منتجات المشروع</p>
    ...
    <div class="mt-3 col-12">
      <p>عملاء المشروع</p>
      <input class="form-control py-3 px-5 fs-r-12" type="text" placeholder="ذكر جميع شرائح العملاء المستهدفين" />
    </div>
    <div class="mt-3 col-12">
    ...
    <div class="mt-3" style="widthfit-content">
      ...
      <div v-for="(state, i) in items" :key="i" class="form-check  d-flex align-items-center mb-1">

        <input class="form-check-input mx-2" type="radio" :value="state.id" v-model="stateValue"
