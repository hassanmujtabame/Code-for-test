<template>
  <div class="box border rounded-3 p-2 mt-3">
                        ...
                        <div class="">
                          <div class="box">
                            بعض الملاحظات عن حضور اللمعرض زي مثلا نرجو عدم اصحاب الاطفال او اي تفاصيل تانية عن الحضور مثلا يمنع الدخول بالمأكولات - لو معرض ازياء هنلقوه لا يوجد غرفة للقياس في المعرض لو مجوهرات ممكن نقوله ثمن الثمن المجوهرات يدفع كاش ولا يوجد تقسيط وهذكدا - تعليمات الدخول يعني بمعنى اصح
                          </div>
                          <div class="pt-3">
                            <h3 class="border-bottom py-2">
                                تفاصيل  الخدمة
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 d-flex">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12.0019 16.3299C9.61187 16.3299 7.67188 14.3899 7.67188 11.9999C7.67188 9.60992 9.61187 7.66992 12.0019 7.66992C14.3919 7.66992 16.3319 9.60992 16.3319 11.9999C16.3319 14.3899 14.3919 16.3299 12.0019 16.3299ZM12.0019 9.16992C10.4419 9.16992 9.17188 10.4399 9.17188 11.9999C9.17188 13.5599 10.4419 14.8299 12.0019 14.8299C13.5619 14.8299 14.8319 13.5599 14.8319 11.9999C14.8319 10.4399 13.5619 9.16992 12.0019 9.16992Z" fill="#979797"/>
                                        <path d="M11.9981 21.0205C8.23812 21.0205 4.68813 18.8205 2.24812 15.0005C1.18813 13.3505 1.18813 10.6605 2.24812 9.00047C4.69812 5.18047 8.24813 2.98047 11.9981 2.98047C15.7481 2.98047 19.2981 5.18047 21.7381 9.00047C22.7981 10.6505 22.7981 13.3405 21.7381 15.0005C19.2981 18.8205 15.7481 21.0205 11.9981 21.0205ZM11.9981 4.48047C8.76813 4.48047 5.67813 6.42047 3.51813 9.81047C2.76813 10.9805 2.76813 13.0205 3.51813 14.1905C5.67813 17.5805 8.76813 19.5205 11.9981 19.5205C15.2281 19.5205 18.3181 17.5805 20.4781 14.1905C21.2281 13.0205 21.2281 10.9805 20.4781 9.81047C18.3181 6.42047 15.2281 4.48047 11.9981 4.48047Z" fill="#979797"/>
                                        </svg>
                                            <p>
                                                المشاهدات : 
                                                <span class="m-c">
                                ...
                                <div class="col-md-6 d-flex">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 20.25C7.45 20.25 3.75 16.55 3.75 12C3.75 7.45 7.45 3.75 12 3.75C16.55 3.75 20.25 7.45 20.25 12C20.25 16.55 16.55 20.25 12 20.25ZM12 5.25C8.28 5.25 5.25 8.28 5.25 12C5.25 15.72 8.28 18.75 12 18.75C15.72 18.75 18.75 15.72 18.75 12C18.75 8.28 15.72 5.25 12 5.25Z" fill="#979797"/>
                                        <path d="M12 15.75C9.93 15.75 8.25 14.07 8.25 12C8.25 9.93 9.93 8.25 12 8.25C14.07 8.25 15.75 9.93 15.75 12C15.75 14.07 14.07 15.75 12 15.75ZM12 9.75C10.76 9.75 9.75 10.76 9.75 12C9.75 13.24 10.76 14.25 12 14.25C13.24 14.25 14.25 13.24 14.25 12C14.25 10.76 13.24 9.75 12 9.75Z" fill="#979797"/>
                                        <path d="M12 4.75C11.59 4.75 11.25 4.41 11.25 4V2C11.25 1.59 11.59 1.25 12 1.25C12.41 1.25 12.75 1.59 12.75 2V4C12.75 4.41 12.41 4.75 12 4.75Z" fill="#979797"/>
                                        <path d="M4 12.75H2C1.59 12.75 1.25 12.41 1.25 12C1.25 11.59 1.59 11.25 2 11.25H4C4.41 11.25 4.75 11.59 4.75 12C4.75 12.41 4.41 12.75 4 12.75Z" fill="#979797"/>
                                        <path d="M12 22.75C11.59 22.75 11.25 22.41 11.25 22V20C11.25 19.59 11.59 19.25 12 19.25C12.41 19.25 12.75 19.59 12.75 20V22C12.75 22.41 12.41 22.75 12 22.75Z" fill="#979797"/>
                                        <path d="M22 12.75H20C19.59 12.75 19.25 12.41 19.25 12C19.25 11.59 19.59 11.25 20 11.25H22C22.41 11.25 22.75 11.59 22.75 12C22.75 12.41 22.41 12.75 22 12.75Z" fill="#979797"/>
                                        </svg>
