   ...
   <div class="container mt-5">
            <div>
                <h2 class="text-center">
                    المزايا المُقدّمة من رياديات إلى الشركاء
                </h2>
                    ...
                    <div class="col-md-4 ">
                        <div class="box border text-center p-3 rounded-2">
                            ...
                            <p>
                                ...
                                موقع وتطبيق رياديــــــــات الإلكتروني لمدة 3 أشهُـــــر
                                مجانـــــــــــــــــــــــــــــــــــــاً </p>
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <div class="box border text-center p-3 rounded-2">
                    ...
                    <div class="col-md-4 ">
                        <div class="box border text-center p-3 rounded-2">
                            ...
                            <p>
                                ...
                                لأعضاء شبكة رياديــــــــــات </p>
