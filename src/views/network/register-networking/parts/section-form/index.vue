            ...
            <div class="box bg-white  p-3  rounded-4">
                <div class="row align-items-center ">
                    <div class="col-md-6">
                        ...
                        <ValidationObserver ref="form" tag="form" @submit="save" autocomplete="off"
                            class="row g-3 needs-validation" novalidate>
                            <div class="col-md-4 w-100">
                                <ValidationProvider :name="$t('company-name')" vid="company_name" rules="required"
                                    v-slot="{ errors }">
                            ...
                            <template v-if="!token">
                                <div class="col-md-4 w-100">
                                    <ValidationProvider :name="$t('Email')" vid="email" rules="required|email"
                                        v-slot="{ errors }">
                            ...
                            <div class="col-md-4 w-100">
                                <ValidationProvider :name="$t('company_website')" vid="website" rules="required"
                                    v-slot="{ errors }">
                                    <d-text-input :errors="errors" :label="$t('company_website')"
                            ...
                            <div class="col-md-4 w-100">
                                <ValidationProvider :name="$t('specialist_field')" vid="category_id" rules="required"
                                    v-slot="{ errors }">
                                    <d-select-input v-model="itemForm.category_id" :errors="errors"
                            ...
                            <div class="col-md-4 w-100">
                                <ValidationProvider :name="$t('provided-services')" vid="services" rules="required"
                                    v-slot="{ errors }">
                                    <d-multi-select-tag v-model="itemForm.services" :placeholder="$t('add_service')">
                            ...
                            <div class="col-md-4 w-100">
                                <ValidationProvider :name="$t('What_will_you_offer_to_Riadiat')" vid="description" rules=""
                                    v-slot="{ errors }">
                                    <label class="form-label">{{ $t('What_will_you_offer_to_Riadiat') }}</label>
                                    <d-ckeditor-classic v-model="itemForm.description" class="form-control px-2" cols="30"
                                        rows="5" :placeholder="$t('What_will_you_offer_to_Riadiat')"></d-ckeditor-classic>
                                    <div v-if="errors.length !== 0" class="col-12 text-input-error">
                                        {{ errors[0] }}
                                    </div>
                                </ValidationProvider>
                            ...
                            <div class="col-md-4 w-100">
                                <ValidationProvider :name="$t('Commercial_Register')" vid="services"
                                    rules="required|ext:pdf" v-slot="{ errors, validate }">
                                    <label class="w-100 position-relative border rounded-2">
                                        <input type="file" @change="uploadFile($event) || validate($event)"
                                            class="form-control opacity-0 " accept=".pdf" required>
                            ...
                            <div class="col-12 m-2 text-start ">
                                <button class="btn btn-main  " type="submit" @click="save" role="button"> {{
