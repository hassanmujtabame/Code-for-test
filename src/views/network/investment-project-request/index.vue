                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label for="imginput" class="form-label file-label first w-100">
                                ...
                                <div class="add-img-selected w-100">
                                    <img class="image-selected-dialog" :src="showImage??'none'" :style="{opacity:showImage?'1':'0'}" :id="idImage" width="100%" height="236" />
                                </div>
                            </label>
                            <ValidationProvider
                                    :name="$t('Image')"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                tag="div"
                                class="row"
                                :name="$t('offered_property')"
                                vid="offered_property"
                                rules="required"
                                v-slot="{errors}"
                                >
                                <div class="col-4">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                tag="div"
                                class="row"
                                :name="$t('amount_financing_required')"
                                vid="amount_financing_required"
                                rules="required"
                                v-slot="{errors}"
                                >
                                <div class="col-4">
                                ...
                                <div class="col-8 position-relative ">
                                 <input v-model="itemForm.amount_financing_required" class="form-control"  placeholder="أدخل الحد الادنى للمبلغ  ">
                                <div style="top: 20%;left: 15px;" class="position-absolute m-c fw-bolder">
                                    ريال
                                </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="col-8 position-relative">
                                <input  v-model="itemForm.minimum_investment"  class="form-control"  placeholder="أدخل قيمة المبلغ">
                                <div style="top: 20%;left: 15px;" class="position-absolute m-c fw-bolder">
                                    ريال
                                </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                tag="div"
                                class="row"
                                :name="$t('investment_contract')"
                                vid="investment_contract"
                                rules="required"
                                v-slot="{validate,errors}"
                                >
                                <div class="col-4">
                                ...
                                <div
                                    ...
                                    <input class="form-control opacity-0 w-100 position-absolute" 
                                    type="file"
                    ...
                    <div class="border  mt-5 ">
                        ...
                        <div class="  p-2">
                            <div class="mt-4">
                                ...
                                <div class="col-12 position-relative">
                                            <d-ckeditor-classic v-model="itemForm.problem_solved" class="w-100 border p-2" rows="15"
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-12 position-relative">
                                                <d-ckeditor-classic v-model="itemForm.future_plan" class="w-100 border p-2" rows="15"
