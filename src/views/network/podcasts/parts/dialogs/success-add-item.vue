<template>
    ...
    >
      <template v-slot>
          ...
          <div class="mt-3">
            <button @click="goItem" style="height: 40px;" class="btn btn-main"> {{$t('podcast')}}</button>
          </div>
          <div class="mt-3">
  ...
  export default {
   ...
   methods:{
      goItem(){
        this.closeEvent()
        this.$router.push(this.getRouteLocale('network-podcast-show',{id:this.itemForm.id}))
      },
      openDialog(data){
