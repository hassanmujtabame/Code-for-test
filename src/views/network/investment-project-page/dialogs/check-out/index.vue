            ...
            <div class="box p-4 shadow m-4 chekout">
                <div class="row justify-content-between">
                    <div class="col-md-5">
                        ...
                        <div class="mt-5">
                            <form action="">
                                <input type="text" class="border rounded-2 w-100  p-2" name="" id="" placeholder="رقم البطاقة">
                                <input type="text" class="border rounded-2 w-100  p-2 mt-3" name="" id="" placeholder=" اسم صاحب البطاقة">
                                <input type="text" class="border rounded-2 w-100  p-2 mt-3" name="" id="" placeholder=" رمز الحماية">
                                <input type="text" class="border rounded-2 w-100  p-2 mt-3" name="" id="" placeholder="  تاريخ الانتهاء">
                        ...
                        <div class="box border p-4 ">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <div>
                                    ...
                                    <p  class="p-0 m-0">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8.0013 15.1667C4.50797 15.1667 1.66797 12.3267 1.66797 8.83333C1.66797 5.34 4.50797 2.5 8.0013 2.5C11.4946 2.5 14.3346 5.34 14.3346 8.83333C14.3346 12.3267 11.4946 15.1667 8.0013 15.1667ZM8.0013 3.5C5.0613 3.5 2.66797 5.89333 2.66797 8.83333C2.66797 11.7733 5.0613 14.1667 8.0013 14.1667C10.9413 14.1667 13.3346 11.7733 13.3346 8.83333C13.3346 5.89333 10.9413 3.5 8.0013 3.5Z" fill="#414042"/>
                                            <path d="M8 9.16659C7.72667 9.16659 7.5 8.93992 7.5 8.66659V5.33325C7.5 5.05992 7.72667 4.83325 8 4.83325C8.27333 4.83325 8.5 5.05992 8.5 5.33325V8.66659C8.5 8.93992 8.27333 9.16659 8 9.16659Z" fill="#414042"/>
                                            <path d="M10 1.83325H6C5.72667 1.83325 5.5 1.60659 5.5 1.33325C5.5 1.05992 5.72667 0.833252 6 0.833252H10C10.2733 0.833252 10.5 1.05992 10.5 1.33325C10.5 1.60659 10.2733 1.83325 10 1.83325Z" fill="#414042"/>
                                            </svg>
                                            شهرياً
                                    </p>
                                </div>
