        ...
        <div class="col-12 col-lg-7">
            ...
            <div class="col-23 col-md-12">
              <div class="form-group position-relative">
                <label class="form-label"
                  >{{ $t("start_date_exhibition") }} -
                  {{ $t("end_date_exhibition") }}</label
                >
                <date-picker-range
          ...
          <div class="mb-3 row">
            ...
            <div class="col-23 col-md-12">
              <div class="form-group position-relative">
                <label class="form-label"
                  >{{ $t("start_time_exhibition") }} -
                  {{ $t("end_time_exhibition") }}</label
                >
                <date-picker-range
          ...
          <div class="mb-3">
            ...
            >
              <label class="form-label"
                >أكتب التفاصيل الخاصة بالمعرض ( عن المعرض و اهميته و المنتجات
                المعروضة به )</label
              >
              <d-ckeditor-classic
                class="form-control"
