...
<svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg">
 ...
 <p class="mt-1">
    أنت الان على وشك حذف العرض الخاص بك
 </p>
 <p class="m-c m-0">
    {{itemSelected.title}}
 </p>
    ...
    <template v-slot:actions>
        <button @click="delBlog" style="height: 40px;" class="btn btn-main"> تأكيد الحذف</button>
    </template>
  </d-dialog-large>
</template>

<script>
import serviceAPI from '@/services/api/exhibitions.js'
export default {
 props:{
    group:{
        type:String,
 ...
 methods:{
    ...
    openDialog(data){
      this.itemSelected=Object.assign({},data);
      this.showed=true
      return true;
    },
    closeDialog(){
