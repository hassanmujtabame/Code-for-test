<template>
    <div class="container">
        <div class="d-flex flex-wrap justify-content-between">
            <div class="">
                <h3>مشروع مادي : {{ itemPage.title }}</h3>
            </div>
            <div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                ...
                :itemPage="itemPage" 
                :isOwner="isOwner"
                 @make-finance="openConfirmFinanceDialog" 
                 />
            </div>
        </div>
        <div class="row justify-content-between mt-3">
            ...
            <div class="col-md-4">
                <!--updates card-->
                <updatesCard :itemPage="itemPage" :isOwner="isOwner" />
                <!--team-card -->
                <teamCard :itemPage="itemPage" :isOwner="isOwner" />
                <!--contract-investment-->
                <contractInvestment :itemPage="itemPage" :isOwner="isOwner" />
...
import updatesCard from './updates-card.vue';
import teamCard from '../common/team-card';
import contractInvestment from './contract-investment.vue';
export default {
