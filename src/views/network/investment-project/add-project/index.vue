                  ...
                  <ValidationProvider tag="div" class="row" :name="$t('minimum_rent')"
                    ...
                    <div class="col-8 position-relative ">
                      <input v-model="itemForm.amount_financing_required" class="form-control"
                             name="amount_financing_required"
                ...
                <ValidationProvider tag="div" class="row" :name="$t('investment_contract')"
                  ...
                  <div class="col-8 position-relative d-flex  align-items-center">
                    <div
                      ...
                      <input class="form-control opacity-0 w-100 position-absolute" name="investment_contract"
                             type="file"
                ...
                <div>
                  ...
                  <div class="row " :class="{'mt-4':itemForm.investment_type!='physical'}">
                    ...
                    <div class="col-md-10">
                      ...
                      <ValidationProvider tag="div" class="col-12 mt-1" :name="$t('attachment')"
                                          vid="description_file" rules="required|ext:mp4,jpep,jpg,git,png"
                  ...
                  <div v-if="isPhysical" class="row mt-4">
                    ...
                    <div class="col-md-10">
                      ...
                      <ValidationProvider tag="div" class="col-12 mt-1" :name="$t('attachment')"
                                          vid="problem_solved_file" rules="required|ext:mp4,jpep,jpg,git,png"
                                          v-slot="{ errors,validate }">
                  ...
                  <div v-if="isPhysical" class="row mt-4">
                    ...
                    <div class="col-md-10">
                      ...
                      <ValidationProvider tag="div" class="col-12 mt-1" :name="$t('attachment')"
                                          vid="future_plan_file" rules="required|ext:mp4,jpep,jpg,git,png"
                                          v-slot="{ errors,validate }">
