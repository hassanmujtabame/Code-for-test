<template>
    <d-dialog-large :xl="false" :open-dialog="openDialog" :close-dialog="closeDialog" :group="group">
        ...
        <template v-slot>
            <ValidationObserver ref="form" tag="form" @submit="save" autocomplete="off" class="row g-3 needs-validation"
                novalidate>
                <div class="col-md-4 w-100">
                    <ValidationProvider :name="$t('company-name')" vid="company_name" rules="required" v-slot="{ errors }">
                        <d-text-input :errors="errors" type="text" class="form-control" v-model="itemForm.company_name"
                ...
                <div class="col-md-4 w-100">
                    <ValidationProvider :name="$t('company_website')" vid="website" rules="required" v-slot="{ errors }">
                        <d-text-input :errors="errors" type="text" class="form-control" :label="$t('company_website')"
                ...
                <div class="col-md-4 w-100">
                    <ValidationProvider :name="$t('provided-services')" vid="services" rules="required" v-slot="{ errors }">
                ...
                <div class="col-md-4 w-100">
                    <ValidationProvider :name="$t('Commercial_Register')" vid="services" rules="ext:pdf"
        ...
        <template v-slot:actions>
            <div class="col-12 m-2 text-start ">
                <button class="btn btn-main  " type="submit" @click="save" role="button"> {{ $t('update') }} </button>
            </div>
        </template>
    </d-dialog-large>
</template>
