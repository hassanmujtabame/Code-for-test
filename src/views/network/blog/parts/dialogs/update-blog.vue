<template>
    <d-dialog-large mlg :group="group" :loading="loading" :closeDialog="closeDialog" :openDialog="openDialog">
            ...
            <div class=" add-portfolio m-3 p-0">
                <div class="   m-auto">
                    <div class="col-md-12 text-center">
                        ...
                        <ValidationProvider :name="$t('Image')" vid="image" rules="image" v-slot="{ validate, errors }">
                ...
                <div class="">
                    <div class="mb-3">
                        <ValidationProvider :name="$t('blog-title')" vid="title" rules="required" v-slot="{ errors }">
                            <input :errors="errors" type="text" v-model="blog.title" class="form-control"
                                :label="$t('blog-title')">
                    ...
                    <!-- category-->
                    <div class="mb-3">
                        <ValidationProvider :name="$t('blog-category')" vid="category_id" rules="required"
                            v-slot="{ errors }">

                            <d-multiselect-input track-id="id" label-name="name" multi-select :opts="categories"
                                v-model="blog.category_id" :errors="errors" :label="$t('blog-category')">
                            </d-multiselect-input>
                        </ValidationProvider>
                    </div>
                    ...
                    <!--content-->
                    <div class="mb-3">
                        <ValidationProvider :name="$t('description_blog')" vid="description" rules="required"
                            v-slot="{ errors }">
                            <label class="form-label">{{ $t('description_blog') }}</label>
                            <d-ckeditor-classic v-if="showDialog" v-model="blog.description" class="form-control" rows="10"
