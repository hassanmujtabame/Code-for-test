                ...
                <div class=" p-3">
                    <div class="row  align-items-start">
                        ...
                        <div class="col-md-9 row">
                            <div class="w-100 ">
                                <ValidationProvider :name="$t('Country')" vid="country_id" rules="required"
                                    v-slot="{ errors }">
                                    <div class="mb-3 ">
                                        <select v-model="itemForm.country_id" class="form-select">
                                            <option value="" class="t-c " disabled selected>{{ $t('select_country') }}
                                            </option>
                    ...
                    <div class="row align-items-start ">
                        ...
                        <div class="col-md-9 row mb-3 ">
                            ...
                            <ValidationProvider :name="$t('Region')" vid="region" rules="required" v-slot="{ errors }">
                                <input type="text" v-model="itemForm.region" class="form-control"
                                    :placeholder="$t('write_region_name')">
                                <d-error-input :error="errors" v-if="errors.length" />
                            </ValidationProvider>
                    ...
                    <div class="row  align-items-start">
                        ...
                        <div class="col-md-9 row mb-3">
                            <ValidationProvider :name="$t('City')" vid="city" rules="required" v-slot="{ errors }">
                                <input type="text" v-model="itemForm.city" class="form-control"
                    ...
                    <div class="row align-items-start ">
                        <label class="col-md-3 m-c fs-5 fw-bolder">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path
                                    ...
                                    fill="#1FB9B3" />
                                <path
                                    d="M3.99997 6.75043C3.80997 6.75043 3.61994 6.68043 3.46994 6.53043L1.46994 4.53043C1.17994 4.24043 1.17994 3.76043 1.46994 3.47043L3.46994 1.47043C3.75994 1.18043 4.24 1.18043 4.53 1.47043C4.82 1.76043 4.82 2.24043 4.53 2.53043L3.05997 4.00043L4.53 5.47043C4.82 5.76043 4.82 6.24043 4.53 6.53043C4.38 6.68043 4.18997 6.75043 3.99997 6.75043Z"
                                    fill="#1FB9B3" />
                                <path
                                    d="M20 6.75043C19.81 6.75043 19.6199 6.68043 19.4699 6.53043C19.1799 6.24043 19.1799 5.76043 19.4699 5.47043L20.94 4.00043L19.4699 2.53043C19.1799 2.24043 19.1799 1.76043 19.4699 1.47043C19.7599 1.18043 20.24 1.18043 20.53 1.47043L22.53 3.47043C22.82 3.76043 22.82 4.24043 22.53 4.53043L20.53 6.53043C20.38 6.68043 20.19 6.75043 20 6.75043Z"
                                    fill="#1FB9B3" />
                            </svg>
                            {{ $t('Street') }} :
                        </label>
                        <div class="col-md-9 row mb-3 ">
                            ...
                            <ValidationProvider :name="$t('Street')" vid="street" rules="required" v-slot="{ errors }">
                                <input type="text" v-model="itemForm.street" class="form-control"
                                    :placeholder="$t('write_street_name')">
                                <d-error-input :error="errors" v-if="errors.length" />
                            </ValidationProvider>
