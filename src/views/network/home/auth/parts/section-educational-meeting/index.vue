<template>
  <div class="mt-5 p-3">
    ...
    <div class="container">
      ...
      <d-swiper v-if="!loading" :slides-per-view="3" is-auto :space-between="5" :items="items">
...
export default {
  ...
  data: () => ({
    ...
    total: 0,
    items: [
      /*{title:'خطة العمل ودراسة الجدوى المالية',owner:'مجلس',date:'23 يوليو',img:`${vm.publicPath}assets/img/learning.png`},
      {title:'خطة العمل ودراسة الجدوى المالية',owner:'مجلس',date:'23 يوليو',img:`${vm.publicPath}assets/img/learning.png`},
      {title:'خطة العمل ودراسة الجدوى المالية',owner:'مجلس',date:'23 يوليو',img:`${vm.publicPath}assets/img/learning.png`},
      {title:'خطة العمل ودراسة الجدوى المالية',owner:'مجلس',date:'23 يوليو',img:`${vm.publicPath}assets/img/learning.png`},
      {title:'خطة العمل ودراسة الجدوى المالية',owner:'مجلس',date:'23 يوليو',img:`${vm.publicPath}assets/img/learning.png`},
