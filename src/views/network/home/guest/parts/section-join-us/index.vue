<template>
  <div
    class="main-background-color py-2 position-relative mt-5"
    :class="{ 'px-5': !isMobile }"
  >
    <div class="row align-items-center p-5 m-auto">
      <div class="col-12 col-md-8 mt-3">
        <h2 class="home-section-title text-white">تشاركينا ؟</h2>

        <p
          class="text-white"
          v-if="user && user.partner"
...
.main-background-color {
  background-image: linear-gradient(to left, #bbd2c5, #1fb9b3);
}
</style>
