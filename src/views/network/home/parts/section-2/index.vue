  ...
  <div class="container mt-5">
    <div class="row align-items-center m-auto">
      ...
      <div class="col-md-6 text">
        ...
        <p>
          رياديات شبكة تضم نخبة من رائدات الأعمال والمستثمرات والشركاء، وتهدف إلى إلهام وتمكين وجمع رائدات الأعمال معًا
          على منصة واحدة ليساعد بعضهن البعض الآخر على النجاح في أعمالهن. ويمكن من خلالها الحصول على المساعدة والتشجيع
          للدخول في مجال ريادة الأعمال من خلال مجموعة من الخدمات والمزايا، وقد صممت لمساعدة رائدات الأعمال على التعلم
          وزيادة نمو أعمالهن والتواصل مع الرياديات
        </p>
      </div>
    </div>
    <div class="mt-5">
          ...
          <div class="carwsel-slider-item rounded-4">
            <div class="row pt-3">
              ...
              <div class="col-md-5 riad-img-carwsel">
                <img :src="`${publicPath}assets/img/1663686448841 1.png`" alt="" width="450.14" height="276" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="carwsel-slider-item rounded-4">
            <div class="">
              <div class="position-relative">
                <img style="opacity: 0.6" :src="`${publicPath}assets/img/NoPath - Copy (2).jpg`" alt="" height="292" />
        ...
        <div style="height: 287.9px" class="item">
          <div style="height: 287.9px" class="carwsel-slider-item rounded-4">
            <div class="text-descoun-carwsel">
              ...
              <h2 style="font-size: 185.19px" class="m-0 text-white text-center position-relative">
                % 70
                <p style="top: 56px; left: 74%" class="position-absolute">
                  <svg width="107" height="94" viewBox="0 0 107 94" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="white" stroke-width="2.93433" stroke-miterlimit="1.5" stroke-linecap="round"
