<template>
  <div class="container mt-5">
    <d-filter-list :pluralName="$t('the_meetings')" :singleName="$t('meeting')" :call-list="loadList"
      :searchPlaceholder="$t('search_by_name')" classColCard="col-12 col-md-6 mt-2" @change="changeFilter">
