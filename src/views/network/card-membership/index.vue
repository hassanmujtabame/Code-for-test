      ...
      <div class="container">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6">
              <div>
                <h3 class="home-section-title">بطاقة رياديات</h3>
                <p class="page-text">
                  بفضل بطاقة العضوية في رياديات، يمكنك الآن الحصول على خصومات
                  حصرية في مجموعة متنوعة من المحلات والمتاجر المحلية.
                </p>
                <!-- <p class="page-text">
                نبذه عن بطاقة العضوية واهميتها و ازاي هنستخدمها يعني نكتب تفاصيل
                عنها بطريقة توضح اهميتها و بتجدد كل قد ايه - كل التفاصيل عنها
                بمعنى اصح بس بطريقة تشد الانتباه
              </p> -->
                <!-- <p class="page-text">
                نبذه عن بطاقة العضوية واهميتها و ازاي هنستخدمها يعني نكتب تفاصيل
                عنها بطريقة توضح اهميتها و بتجدد كل قد ايه - كل التفاصيل عنها
                ...
                <button
                  ...
                  class="px-5 btn text-light py-2 mt-3"
                  @click="showCard"
                >
                  <svg
                    width="32"
