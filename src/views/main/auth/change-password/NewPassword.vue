                ...
                <div class="col-12 col-md-6 p-4">
                    ...
                    <div class="">
                        ...
                        <ValidationObserver ref="form" tag="div" class="row g-3 needs-validation">
                            ...
                            <div class="col-md-12">
                                <ValidationProvider tag="div" :name="$t('Password')" vid="new_password" rules="required"
                                    ...
                                    <div class="position-relative">
                                        <input :type="show ? 'text' : 'password'" v-model="itemForm.new_password"
                                            class="form-control" :placeholder="$t('new-password')">

                                        <span style="color: #CDD7D8;font-size: 23px;" toggle="#password-field"
                                            @click="show = !show"
                            ...
                            <div class="col-md-12">
                                <ValidationProvider tag="div" :name="$t('Password-confirm')" vid="new_password_confirmation"
                                    rules="required|confirmed:new_password" v-slot="{ errors }">
                                    <div class="position-relative">
                                        <input :type="showc ? 'text' : 'password'" v-model="itemForm.password_confirmation"
