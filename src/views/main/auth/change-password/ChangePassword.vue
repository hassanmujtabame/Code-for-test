                    ...
                    <div class="">
                        ...
                        <ValidationObserver ref="form" tag="div" class="row g-3 needs-validation">
                            ...
                            <div class="col-md-4 w-100">
                                <ValidationProvider tag="div" :name="$t('Password')" vid="password" rules="required"
                                    v-slot="{ errors }">
                                    <d-text-input :errors="errors" v-model="itemForm.old_password"
                                        :type="show ? 'text' : 'password'" class="form-control" label="كلمة المرور القديمة">
                                ...
                                <div class="col-md-12  mt-3">
                                    <ValidationProvider tag="div" :name="$t('Password')" vid="new_password" rules="required"
                                        v-slot="{ errors }">
                                        <d-text-input :errors="errors" :type="showN ? 'text' : 'password'"
                                            v-model="itemForm.new_password" class="form-control"
                                            :label="$t('new-password')">
                                            <template v-slot:append-icon>
                                                <span style="color: #CDD7D8;font-size: 23px;" @click="showN = !showN"
                                ...
                                <div class="col-md-12 mt-3">
                                    <ValidationProvider tag="div" :name="$t('Password-confirm')"
                                        vid="new_password_confirmation" rules="required|confirmed:new_password"
                                        v-slot="{ errors }">

                                        <d-text-input :errors="errors" :type="showNc ? 'text' : 'password'"
                                            v-model="itemForm.new_password_confirmation" class="form-control"
                                            :label="$t('Password-confirm')">
                                            <template v-slot:append-icon>
                                                <span style="color: #CDD7D8;font-size: 23px;" @click="showNc = !showNc"
                                                    class="fa-regular mx-1"
                            ...
                            <div class="col-12 text-center ">
                                <button @click="resetPassword" class="btn btn-main  " type="submit" role="button"> أستمر
                                </button>
                            </div>
