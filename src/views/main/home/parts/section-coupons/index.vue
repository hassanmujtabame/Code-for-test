               ...
               <div class="row align-items-center px-5 m-auto">
                <div class="col-12 col-md-12 mt-3">
                  ...
                  <p class="text-white" style="max-width:490px">
                    تمتعي بخصومات على الأقمشة ومستحضرات التجميل وكل المواد والأدوات التي تحتاجينها
                  </p>
                
                  <div style="margin-top: 20px;" class="">

                    <router-link  :to="getRouteLocale('network-offers')" role="link" class="btn border p-2 text-white bg-transpernt svg-network ">
