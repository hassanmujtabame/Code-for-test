<template>
  <div id="list-item-1">
    <div class="box border">
      <h3 class="border-bottom py-2 t-c px-3">معلومات العرض</h3>
      <ValidationObserver ref="form">
        <div class="row p-3">
          ...
          <div class="col-md-8 border">
            ...
            <ValidationProvider :name="$t('Bio')" vid="bio" rules v-slot="{errors}">
              <textarea v-model="itemForm.bio" class="w-100 border-0" rows="10"></textarea>
              <d-error-input :errors="errors" v-if="errors.length"></d-error-input>
            </ValidationProvider>
          </div>
