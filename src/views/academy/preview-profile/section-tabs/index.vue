...
<script>
import TabCourses from '@/views/network/preview-profile/section-tabs/tabs/courses-watched/index.vue'
import TabBlog from '@/views/network/preview-profile/section-tabs/tabs/blog/index.vue'
import TabExhibitions from '@/views/network/preview-profile/section-tabs/tabs/exhibitions/index.vue'
import TabStory from '@/views/network/preview-profile/section-tabs/tabs/story/index.vue'
import TabProject from '@/views/network/preview-profile/section-tabs/tabs/project/index.vue'
export default {
 name:'section-tabs',
 components:{ 
    TabCourses,
