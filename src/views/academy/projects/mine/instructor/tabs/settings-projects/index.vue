<template>
    <div class="tab-pane fade show active" id="pills-settings-projects" role="tabpanel"
        aria-labelledby="pills-settings-projects-tab" tabindex="0">
            ...
            <div class="row flex-wrap align-items-center  ">
                <div class="col-md-6">
                    <div class="form-check">
                        <d-check-input v-model="itemForm.send_notice" :false-value="0" :true-value="1">
        ...
        <div class="box mt-4">
            ...
            class="row flex-wrap align-items-center ">
                <div class="col-md-6">
                    ...
                    <div class="form-check">
                        <d-radio-input v-model="itemForm.number_send_project" value="infinite">
                ...
                <div class="col-md-6">
                    <div class="form-check">
                        <d-radio-input v-model="itemForm.number_send_project" value="twice">
                            يمكن لطالب ارسال مشروع مرتين من بعدها يعتبر راسب ولا يحصل على شهادة مطلقا
                        </d-radio-input>
                    </div>
                </div>
        ...
        <div class="text-center mt-4">
            <button @click="save" :disabled="loading" class="btn btn-custmer px-3">
                حفظ الاعدادات
            </button>
        </div>
      ...
      async initializing(){
        ...
        try {
           ...
           if(data.success){
            ...
            this.itemForm = Object.assign(this.itemForm,{send_notice,degree_success,number_send_project})
           }else{
            //window.SwalError(data.message)
           }
        } catch (error) {
