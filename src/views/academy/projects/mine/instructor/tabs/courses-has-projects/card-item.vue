    ...
    <div class="academy-course-exams-item__wrapper">
      <div class="academy-course-exams-item__body">
        <div class="academy-course-exams-item__title">
          <h1>
            أسم الدورة : <span>{{ item.course_name }}</span>
          </h1>
        </div>
        <div class="academy-course-exams-item__description">
          <div
            ...
            :key="i"
            class="academy-course-exam-item my-2"
          >
            ...
            <div class="academy-course-exam-item__actions">
              <button
                ...
                class="btn btn-custmer btn-small"
              >
                تعديل المشروع
              </button>
              <button
                @click="showConfirmDeleteItem(project)"
                class="btn rounded-2 border-danger text-danger bg-transparent btn-small mx-2"
              >
                حذف المشروع
              </button>
            </div>
      ...
      let dataEvent = {
        ...
        btns: [
          { title: "تراجع", class: "btn btn-custmer btn-danger" },
          {
            ...
            action: () => this.deleteLecture(lect),
