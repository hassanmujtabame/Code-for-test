...
<svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg">
 ...
 <p class="mt-1">
  هل أنت متأكد من إلغاء إنضمامك للقاء ؟
 </p>

</div>
    </template>
    <template v-slot:actions>
        <button @click="confirmJoin" style="height: 40px;" class="btn btn-danger"> {{$t('confirm_cancel_join_meeting')}}</button>
    </template>
  </d-dialog-large>
</template>
...
export default {
 props:{
    group:{
        type:String,
        default:'confirm-cancel-join-meeting'
    }
 },
 data:()=>({
    itemDialog:{id:null},
