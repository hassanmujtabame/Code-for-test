 ...
 hideHeader
     ...
     >
              <template v-slot:header>
                ...
                <ValidationObserver v-if="isOwner" ref="form" class="flex-shrink-0" tag="div" v-slot="{invalid }">
...
export default {
    ...
    async deleteItem(item){
        ...
        try {
                        ...
                        let {data} =  await academyAPI.coursesApi.deleteAttachment(item.id)
                        if(data.success){
            ...
            /*if (percent < 100) {
              console.log(`${loaded} bytes of ${total} bytes. ${percent}%`);
                    ...
                    try {
                        ...
                        let {data} =  await academyAPI.coursesApi.addAttachment(this.itemPage.id,formData,config)
                        if(data.success){
