  ...
  data: (vm) => {
    return {
      widgets: [
        ...
        {
          title: "حجزو مقعد للدورة القادمة",
          content: `${vm.itemPage.booking_next_course} شخص`,
          link: null,
        },
        { title: "عدد خريجين الدورة", content: "20/40", link: "/" },
        {
          title: "موعد المجموعه الثانية",
          content: vm.dateReverse(vm.itemPage.next_course_date),
          link: "/",
        },
      ],
    };
