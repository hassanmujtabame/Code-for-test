<template>
    <div class=" d-flex gap-2 justify-content-end my-3">
        ...
        <div>
            <button v-b-modal="'my-modal'" class="btn-main btn-action-page btn-warning  px-3 w-100 border-0 rounded-2"
                role="button">
        ...
        <div>
            <button @click="confirmDeleteItem" class="btn-main btn-action-page btn-delete px-3 w-100 border-0 rounded-2"
                role="button">
