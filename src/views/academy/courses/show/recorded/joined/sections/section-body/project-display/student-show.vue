<template>
    <div class="course-project-display">
        ...
        <p class="course-project-display__observation">اقرا جيدا تعليمات المدرب وقم بارفاق مشروعك بنفس الصيغة التي طلبها
            المدرب</p>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <attachmentCard v-for="(attachment, i) in lectureSelected.attachments" :key="i" :item="attachment"
        ...
        <div v-if="userAcademyRole == 'student'" class="my-3">
            ...
            <ValidationObserver v-else ref="form" tag="div">
                <ValidationProvider :name="$t('project')" vid="file" v-slot="{ errors, validate }">
            ...
            <div class="row">
                <div class="col-12 col-md-6 position-relative">
                    ...
                    <attachmentCard v-if="student_project.id" :item="student_project" :showBorder="false"
                        @delete="showConfirmDeleteProjectFile" canDelete />
                </div>
            </div>
        </div>
