  ...
  <div class="course-show-page__preview">
    <div class="course-show-page__preview-header d-flex">
      ...
      <div v-if="isTablet || isMobile" class="justify-self-end align-self-center">
        <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#course-menu-drawer"
    ...
    <div class="course-show-page__preview-content">
      <div class="course-show-page__preview-content-wrapper">
        ...
        <LectureShow v-else-if="lectureSelected.type == 'lecture' || lectureSelected.type === null" :itemPage="itemPage"
          :lectureSelected="lectureSelected" />

        <ProjectShow v-else-if="['project', 'projects'].includes(lectureSelected.type)" :itemPage="itemPage"
          :lectureSelected="lectureSelected" />

        <div v-else-if="lectureSelected.type == 'exam'" class="rounded-3 w-100 h-100">
  ...
  computed: {
    convertedDate() {
      ...
      if (this.itemPage.type !== 'recorded') {
        formattedDate = `${day} ${this.months[date.getMonth()]} | ${this.itemPage.start_time}`;
      } else {
