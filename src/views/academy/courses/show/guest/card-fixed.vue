<template>
  <div class="card card-info" style="position: absolute !important;" :class="{ 'tablet': isTablet }">
    ...
    <div class="card-body pt-0">
      ...
      <div v-if="token && (userIsSubAcademy && itemPage.user_is_join_course || isOwner || choiceUnlimitedCourses)"
        class="mt-3">
        <button v-if="!isOwner && (!token || !itemPage.user_is_join_course)" @click="inscription"
