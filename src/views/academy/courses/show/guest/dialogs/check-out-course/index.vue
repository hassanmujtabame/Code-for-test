<template>
  <div :group="group" title="تفاصيل الدفع" hideAmount :do-payment="payment">
    <template>
      <div v-if="show" class="d-flex flex-wrap gap-2">
        <div>
          <svg
            width="133"
            height="67"
    ...
    async payment(evt) {
      ...
      try {
        ...
        if (data.success) {
          ...
          this.loadJS(
            `https://test.oppwa.com/v1/paymentWidgets.js?checkoutId=${this.checkoutInfo.id}`,
            true,
            true
          );
