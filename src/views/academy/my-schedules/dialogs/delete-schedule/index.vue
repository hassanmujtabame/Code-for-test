<template>
  ...
  >
    <template v-slot>
      <div class="text-center" v-if="showed" style="margin-top: -50px">
        <svg
          width="250"
          height="200"
          viewBox="0 0 250 200"
        ...
        >
          ...
          />
          <path
            d="M89.6628 79.3115C88.7548 80.8435 87.968 82.4333 87.3125 84.0725"
            stroke="#FF1616"
            stroke-opacity="0.44"
            stroke-width="2.5"
            stroke-linecap="round"
          />
          <path
            d="M108.02 63.0732C101.468 66.2006 95.9353 70.6244 91.9375 75.9203"
            stroke="#FF1616"
            stroke-opacity="0.44"
            stroke-width="2.5"
            stroke-linecap="round"
        ...
        <p class="delete-warning">
          {{ $t("confirm_delete_schedule_warning") }}
        </p>
        <p class="m-c m-0">
          {{ blog.title }}
        </p>
