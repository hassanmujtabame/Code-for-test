<template>
  ...
  >
    <template v-slot:header>{{ $t("edit") }}</template>
                  ...
                  <div class="row p-0">
                    <div class="col-md-6">
                      ...
                      >
                        <label for="input_from">
                          <p>
                            تاريخ
                            <span class="m-c"> بداية الجدول </span>
                          </p>
                        </label>
                        <date-picker-input
                          mode="date"
                          class="form-control"
                          :max-date="
                            itemForm.is_end_date ? itemForm.end_date : ''
                          "
                    ...
                    <div class="col-md-6">
                      ...
                      >
                        <label for="input_to">
                          <p>
                            تاريخ
                            <span class="text-danger"> نهاية الجدول </span>
                          </p>
                        </label>
                        <date-picker-input
                          mode="date"
                          class="form-control"
                          :min-date="itemForm.start_date"
                    ...
                    <div class="form-check m-2">
                      <input
                        ...
                        type="checkbox"
                        :value="itemForm.is_end_date"
                        @change="changeIsEndDate"
                        id="flexCheckChecked"
                      />
                      <label
                        class="form-check-label t-c"
                  ...
                  <div class="row p-0">
                    ...
                    <div class="col-md-6">
                      ...
                      >
                        <label for="input_to">
                          <p>
                            <span class="text-danger"> الى </span>
                          </p>
                        </label>
                        <date-picker-input
                          mode="time"
    ...
    async save() {
      ...
      try {
        let { data } = this.itemForm.id
          ? await ScheduleAPI.updateItem(this.itemForm.id, formData)
          : await ScheduleAPI.addItem(formData);
        if (data.success) {
