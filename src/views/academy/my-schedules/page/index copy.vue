        ...
        <div class="container">
            ...
            <div>
                <div class=" m-4">
                    ...
                    <div id="calendarContainer" class=" date-service-provider "></div>
                </div>
            </div>
        </div>
    </div>
...
export default {
 name:'page-schedule',
 mounted(){
    window.$("#calendarContainer").simpleCalendar({
    displayEvent: true,
    events: [
...
.date-service-provider .calendar .day {
    position: relative;
...
.date-service-provider .calendar .day.today {
    background: #F2631C;
    color: white;
}
