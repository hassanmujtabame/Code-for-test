    ...
    <div class="main-top py-2 px-5 position-relative mt-5">
        <div class="row align-items-center justify-content-center m-auto p-3">
            <div class="col-md-6 ">
                ...
                <p class="text-white">
                    أكاديمية رياديات تضم العديد من المدربين المميزين في الممكلة و الوطن العربي يمكنك أن تنضم لهذه العائلة
                    الان !

                </p>


                <router-link :to="getRouteLocale('academy-instructor-register')"
