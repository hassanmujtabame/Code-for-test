<template>
  <div class="box">
                            <div class="box bg-white   rounded-4 mt-5 p-2 border">
                                ...
                                <div class="p-2 conversation-list">
                                ...
                                <otherMsgText :item="conv" v-else :key="'jj'+i" />
                                    ...
                                    <div class="conversation-list__footer">
                                        ...
                                        <d-error-input :errors="errors" v-if="errors.length" />
                                            ...
                                            <div class="m-2">
                                                <button :disabled="!message || loading" @click="sendMessage" class="btn btn-custmer border rounded-2 p-2">
 ...
 methods:{
    ...
    async sendMessage(evt){
        ...
        evt.preventDefault();
            ...
            try {
                let { data } = await window.axios.post('academy/user/send-message-to-provider',formData)
                 if(data.success){
                    this.pushMessage()
                 }
            } catch (error) {
