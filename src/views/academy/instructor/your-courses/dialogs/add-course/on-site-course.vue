        ...
        <template v-slot:default>
            <div v-if="showDialog" ref="form" class="form-onsite" tag="div">
                <ValidationObserver class="form-step" ref="form1" id="form-step-1" v-show="step == 1">
                    ...
                    <div class="mt-3">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('num_days')" vid="number_day" rules="required|numeric"
                            v-slot="{ errors }" v-if="step == 1">
                    ...
                    <div class="mt-3">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('days_week')" vid="course_days" rules="required" v-slot="{ errors }"
                            v-if="step == 1">
                    ...
                    <div class="mt-3">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('start_date_course')" vid="start_date" rules="required"
                            v-slot="{ errors }" v-if="step == 1">
                    ...
                    <div class="mt-3">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('end_date_course_booking')" vid="reservation_closing_date"
                            rules="required" v-slot="{ errors }" v-if="step == 1">
                    ...
                    <div class="mt-3">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('type_certificate_for_student')" vid="type_certificate"
                            rules="required" v-slot="{ errors }" v-if="step == 1">

                            <d-multiselect-input :errors="errors" label="نوع الشهادة التي تمنح للطلاب"
                                :opts="type_certificates" track-id="id" label-name="name"
                                v-model="itemForm.type_certificate" multi-select seperate=" - " />
                        </ValidationProvider>
                        <!-- </keep-alive> -->
                    </div>
                    <!--number_students -->
                    <div class="mt-3">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('number_students')" vid="number_students" rules="required|numeric"
                            v-slot="{ errors }" v-if="step == 1">
                            <d-text-input type="text" :errors="errors" v-model="itemForm.number_students"
                                label="عدد الطلاب المسموح لهم بالحضور" />
                        </ValidationProvider>
                        <!-- </keep-alive> -->
                    </div>
                </ValidationObserver>
                <ValidationObserver class="form-step" ref="form2" id="form-step-2" v-show="step == 2">
                    ...
                    <div class="mb-3">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('course-title')" vid="title" rules="required" v-slot="{ errors }"
                            v-if="step == 2">
                    ...
                    <div class="mb-3 position-relative">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('course-domain')" vid="department_id" rules="required"
                            ...
                            <d-select-input :errors="errors" v-model="itemForm.department_id" label="حدد مجال الدورة ">
                                ...
                                <option class="t-c" v-for="(dept, i) in departments" :key="i" :value="dept.id"> {{ dept.name
                                }}</option>
                    ...
                    <div class="mb-3 position-relative">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('type-training')" vid="type_training" rules="required"
                            v-slot="{ errors }" v-if="step == 2">
                    ...
                    <div class="my-3">
                        ...
                        <ValidationProvider :name="$t('course-price')" vid="price" rules="required|numeric"
                            v-slot="{ errors }" v-if="step == 2">
                            <d-text-input type="text" :errors="errors" v-model="itemForm.price"
                    ...
                    <div class="mb-3">
                        <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('course-observation')" vid="notes" rules="required" v-slot="{ errors }"
                            v-if="step == 2">
                            <d-textarea-input type="text" :errors="errors" rows="10" v-model="itemForm.notes"
