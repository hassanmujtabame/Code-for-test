                ...
                <div class="mt-3">
                    <!-- <keep-alive> -->
                        <ValidationProvider :name="$t('start_date_course')"
                            ...
                            v-if="step==1"
                        >
                    <d-datepicker-input  v-model="itemForm.start_date" label="متى تريد طرح الدورة للأشتراك ؟ ( أتركها فارغه اذا ترغب بأضافتها على الفور )" />
        ...
        <!-- </keep-alive> -->
            ...
            <div class="mb-3">
                ...
                <ValidationProvider :name="$t('course-code')"
                    ...
                    v-if="step==2"
                    >
                    <d-text-input type="text" :errors="errors"  v-model="itemForm.course_code"  label="أكتب كود الدورة" />
                </ValidationProvider>
            <!-- </keep-alive> -->
                    </div>
