<template>
    ...
    <template v-slot:default>
        ...
        <div class="form-step" id="form-step-1" v-show="step==1">
                <div class="mb-3">
                    <input type="text" class="form-control" name="" id="" placeholder="متى تريد طرح الدورة للأشتراك ؟ ( أتركها فارغه اذا ترغب بأضافتها على الفور )">
                </div>
                <div class="mb-3">
                    <select name="" id="" class="form-select " >
                        <option value="" class="t-c" selected> نوع الشهادة التي تمنح للطلاب  </option>
        ...
        <div class="form-step" id="form-step-2" v-show="step==2">
                ...
                <div class="mb-3 position-relative">
                  <textarea name="" id="" class="w-100 border t-c" rows="10">أكثر من 140,000 طالب مسجلين حتى الآن في النسخة الإنجليزية من هذه الدورة في 196 دولة يرجى العلم بأن هذه الدورة تحتوي على ترجمة باللغة العربية هل أنت جاهز للارتقاء إلى درجة أعلى في حياتك المهنية؟ في هذه الدورة، ستتعلم كل ما تحتاج لمعرفته حول الأعمال والبيزنس ... بداية من إنشاء شركة وحتى طرحها للاكتتاب العام. وتغطي هذه الدورة كافة الموضوعات المهمة التي ستتعلمها عند الحصول على ماجستير إدارة الأعمال من أي كلية من الكليات المرموقة + مفاهيم الأعمال المستمدة من الخبرة العلمية والتي ستجعلك أكثر نجاحًا</textarea>
    ...
    <script>
    export default {
        name:'add-course-dialog-recorded',
      props:{
        group:{
            type:String,
            default:'add-course-recorded'
        }
      },
      data:()=>{
        return{
