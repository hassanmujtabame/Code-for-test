            ...
            <div v-if="showDialog" ref="form" tag="div">
                <ValidationObserver class="form-step" ref="form1" id="form-step-1" v-show="step==1">
                    ...
                    <div class="col-23 col-md-12">
                        <div class="form-group position-relative">
                            <label class="form-label">{{ $t('start-time-course') }} - {{
                                $t('end-time-course')
                                }}</label>
                ...
                <ValidationObserver class="form-step" ref="form2" id="form-step-2" v-show="step==2">
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        >
                            <d-select-input :errors="errors" v-model="itemForm.department_id" label="حدد مجال الدورة ">
                                ...
                                <option class="t-c" v-for="(dept,i) in departments" :key="i" :value="dept.id">
                                    {{ dept.name }}
                                </option>
                    ...
                    <div class="mb-3">
                        ...
                        <ValidationProvider :name="$t('course-meeting-url')"
                                            ...
                                            v-if="step==2"
                        >
                            <d-text-input type="text" :errors="errors" v-model="itemForm.meeting_url"
                                          label="رابط الدورة على زوم او جوجل ميت "/>
                        </ValidationProvider>
                        <!-- </keep-alive> -->
                    </div>
                    <!--has exam-->
                            ...
                            <ValidationProvider
                                ...
                                <div class="d-flex align-items-end">
                                    <input style="z-index: 99;"
                                           ...
                                           class="form-control opacity-0 position-absolute  " type="file"
                                           id="fileinput1">
                                    <div v-if="!itemForm.image_path" id="selected_filename"
                                         class="mx-3 px-4 gray font-13 border-0  position-absolute m-c">
                                        أضف صورة للعرض
                                    </div>
                                </div>
                                <d-error-input :errors="errors" v-if="errors && errors.length>0"/>
                                <img v-if="itemForm.image_path" :src="itemForm.image_path" id="add-course-image"
                                     class="mt-3" height="100" width="100"/>
                            </ValidationProvider>
                            <!-- </keep-alive> -->
                        </div>
                    </div>
                ...
                <ValidationObserver class="form-step" ref="form3" id="form-step-3" v-show="step == 3">
                    ...
                    <div class="mb-3" v-if="itemForm.learn.length < 2">
                        <ValidationProvider :name="$t('what-you-will-learn')" :vid="`learn`"
