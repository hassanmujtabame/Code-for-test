<template>
    ...
    <template v-slot:default>
        <div class="form-step" id="form-step-1" v-show="step==1">
                <div class="mt-3">
                    <d-text-input type="text"  v-model="itemForm.num_days" label="عدد ايام الدورة " />

                </div>
                <div class="mt-3">
                    <d-multiselect-input label="ايام الدورة ( حددي ايام الاسبوع )" :opts="daysOfWeek" 
                ...
                <div class="mt-3">
                    <d-text-input type="text"  v-model="itemForm.type_certificate"  label="نوع الشهادة التي تمنح للطلاب" />
                ...
                <div class="mb-3">
                    ...
                    <d-text-input type="text"  v-model="itemForm.title"  label="عنوان الدورة " />

                </div>
                <div class="mb-3 position-relative">
                    <d-select-input label="حدد مجال الدورة " >
                ...
                <div class="mb-3 position-relative">
                    <d-select-input label="" >
                        <option value="" class="t-c" selected disabled>أضافة اختبار</option>
