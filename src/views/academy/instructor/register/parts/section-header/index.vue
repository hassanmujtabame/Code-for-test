<template>
    <div>
        <div v-if="!loadingImg" @load="loadingImg == false" class="section-header-register-instructor position-relative">
            <div class="position-absolute anim-hwo-ar-you" style="width: 100% ;">
                <img style="width: 100% ; object-fit: cover;" :src="`${publicPath}assets/svg/arabsstock_P34769_large1.svg`"
                    height="612" alt="">
            </div>
        ...
        <div v-else class="d-flex justify-content-center align-items-center" style="height: 280px;
        background: #464646ab;">
            <div>
                <i style="    color: white;
                font-size: 50px;" class="fa fa-spinner fa-spin"></i>
            </div>
        </div>
    </div>
</template>
...
.section-header-register-instructor {
    height: 612px;
    display: flex;
...
.section-header-register-instructor__wrapper {
    position: relative;
    z-index: 2;

}

.section-header-register-instructor__title {
    font-style: normal;
    font-weight: 600;
    font-size: 56px;
    line-height: 72px;
...
.section-header-register-instructor__text {
    font-style: normal;
    font-weight: 400;
    font-size: 24px;
    line-height: 32px;
