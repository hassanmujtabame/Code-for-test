<template>
  <div
    ...
    id="pills-settings-exams"
    role="tabpanel"
    aria-labelledby="pills-settings-exams-tab"
    tabindex="0"
  >
    <div class="box mt-4">
      <div class="d-flex align-items-center justify-content-between">
        <div>
          <h4>أظبط أعدادات الاشعارات :</h4>
        </div>
      </div>
