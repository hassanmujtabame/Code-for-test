<template>
  <div>
    <div class="overflow-x-none overflow-x-hidden">
      ...
      <div class="container p-5 mt-5">
        <div class="row mb-3 mt-2">
          <h1>اكاديمية رياديات: وسع دائرة معارفك</h1>
          <h5 style="color: #888">
            رياديات شبكة تضم نخبة من رائدات الأعمال والمستثمرات والشركاء، وتهدف
            إلى إلهام وتمكين وجمع رائدات الأعمال معًا على منصة واحدة ليساعد
            بعضهن البعض الآخر على النجاح في أعمالهن. ويمكن من خلالها الحصول على
            المساعدة والتشجيع للدخول في مجال ريادة الأعمال من خلال مجموعة من
            الخدمات والمزايا، وقد صممت لمساعدة رائدات الأعمال على التعلم وزيادة
            نمو أعمالهن والتواصل مع الرياديات
          </h5>
        </div>
      ...
      > -->
        <div style="" class="row position-relative">
          <div
    ...
    checkTypePackage() {
      ...
      if (this.user.system_subscriptions) {
        for (
          ...
          if (
            element.system_package.related_to.key == "academy" &&
            element.end_at > date
          ) {
