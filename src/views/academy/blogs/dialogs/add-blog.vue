                ...
                <div class="">
                    <div class="mb-3">
                        <ValidationProvider :name="$t('blog-title')" vid="title" rules="required" v-slot="{ errors }">
                            <d-text-input type="text" :errors="errors" v-model="blog.title" class="form-control"
                                :label="$t('blog-title')" />
                    ...
                    <!--content-->
                    <div class="mb-3">
                        <ValidationProvider :name="$t('blog-content')" vid="description" rules="required" v-slot="{ errors }">
                            <label class="form-label">{{ $t('blog-content') }}</label>
                            <d-ckeditor-classic v-model="blog.description" class="form-control" rows="10" :editorConfig="{
                                minHeight: '150px'
