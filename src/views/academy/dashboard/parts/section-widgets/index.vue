          ...
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.19"
              />
              <g clip-path="url(#clip0_3581_13465)">
                <path
          ...
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.19"
              />
              <g clip-path="url(#clip0_3581_13444)">
                <path
                  d="M41.3286 22.1634V21.8077C41.3286 20.1727 39.9529 18.8425 38.2619 18.8425H20.6487C18.9577 18.8426 17.582 20.1727 17.582 21.8077V22.1634H41.3286Z"
                  fill="#FFBC00"
                />
          ...
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.21"
              />
              <g clip-path="url(#clip0_3581_13508)">
                <path
                  d="M41.3286 22.1634V21.8077C41.3286 20.1727 39.9529 18.8425 38.2619 18.8425H20.6487C18.9577 18.8426 17.582 20.1727 17.582 21.8077V22.1634H41.3286Z"
                  fill="#F2631C"
                />
          ...
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.19"
              />
              <g clip-path="url(#clip0_3581_13487)">
                <path
                  d="M41.3286 22.1634V21.8077C41.3286 20.1727 39.9529 18.8425 38.2619 18.8425H20.6487C18.9577 18.8426 17.582 20.1727 17.582 21.8077V22.1634H41.3286Z"
                  fill="#2C98B3"
                />
          ...
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.19"
              />
              <g clip-path="url(#clip0_3581_13551)">
                <path
                  d="M41.3286 22.1634V21.8077C41.3286 20.1727 39.9529 18.8425 38.2619 18.8425H20.6487C18.9577 18.8426 17.582 20.1727 17.582 21.8077V22.1634H41.3286Z"
                  fill="#FFBC00"
                />
    ...
    <div class="p-3 col-md-6 col-12">
      ...
      >
        <div class="d-flex align-items-center gap-4">
          ...
          <div class="d-flex flex-column justify-content-center gap-1">
            <h3 style="color: #2c98b3">جدولي</h3>
            <button
              @click="router_push('service-provider-rate-my-service')"
              style="
                color: #888;
    ...
    <div class="p-3 col-md-6 col-12">
      ...
      >
        <div class="d-flex align-items-center gap-4">
          ...
          <div class="d-flex flex-column justify-content-center gap-1">
            <h3 style="color: #2c98b3">نتائج اختباراتك</h3>
            <button
              @click="router_push('service-provider-rate-my-service')"
              style="
                color: #888;
