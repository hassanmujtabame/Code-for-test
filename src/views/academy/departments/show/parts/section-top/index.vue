<template>
  <div class="main-top py-5 position-relative">
        <h1 class="text-white px-5 fs-1 position-relative z-index-1"
        style="width: 668px;margin: 0 67px;"
        >ابـــرزي شـــغــفــك وطوري موهـبتـــك في مجال {{itemPage.title}}</h1>
