  ...
  <div class="main-top py-2 px-5 position-relative mt-5">
    <div class="row align-items-center m-auto">
      <div class="box col-md-6">
        <h1 class="text-white fw-bolder fs-1">تبحث عن وظيفة ؟</h1>
        <p class="text-white w-75">
          مقدمي خدمة رياديات تقدم لك الكثير من الوظائف المميزة التي يمكنك ترشيح
          نفسك فيها
        </p>
        <router-link
      ...
      <div class="col-md-6">
        <img
          class="img-fluid"
          :src="`${publicPath}assets/img/Group service.png`"
          alt=""
        />
      </div>
    </div>
  ...
  <!-- <div class="main-top py-2 px-5 position-relative mt-5">
            <div class="row align-items-center m-auto">
                <div class="box col-md-6" >
                    ...
                    <h1 class="text-white fw-bolder fs-1">
                        تبحث عن وظيفة ؟
                    </h1>
                    <p class="text-white w-75">
                        مقدمي خدمة رياديات تقدم لك الكثير من الوظائف المميزة التي يمكنك ترشيح نفسك  فيها              
                   </p>
                   <router-link :to="getRouteLocale('service-provider-jobs')" class="btn border p-2 text-white bg-transpernt svg-network ">
                ...
                <div class="col-md-6">
                    <img class="img-fluid" :src="`${publicPath}assets/img/Group service.png`" alt="">
                </div>
            </div>
