  ...
  <div class="w-100">
    <div class="container pt-5">
     ...
     <showProposal
          ...
          :department="itemPage.category_name"
          :category="itemPage.field_name"
          :price="itemPage.price"
          :execution-time="itemPage.execution_period"
          :during="itemPage.rest_days"
          :place="itemPage.city"
          :offers="itemPage.count_offer"
          :datePublish="itemPage.created_at"
          :image="itemPage.image"
          :state="itemPage.state"
          :id="itemPage.id"
          :shareLink="shareLink"
        />
        </div>
            ...
            <div class="box border p-3 rounded-2" :class="{'mt-5l':!isOwner}">
              ...
              <div class="row">
                ...
                <div class="col-6 p-2">
                  ...
                  <span
                    class="m-c"
                  >{{itemPage.created_at?timeAgoToHuman(itemPage.created_at):'N/A'}}</span>
                </div>
