    ...
    <div class="container p-5 mt-5">
      ...
      <div>
        <div class="row redy-services">
          <div class="row">
            <div class="col-md-6 ">
              <div class="box border p-3 rounded-2 d-flex flex-row justify-content-between align-items-center">
                <h3 class="m-c m-0">
                  {{ itemPage.title }}
                </h3>
            ...
            <div class="col-md-6 ">
              <div v-if="isOwner"
                ...
                <router-link :to="getRouteLocale('service-provider-my-proposal-offers', { id: itemPage.id })"
                  class="btn btn-main" style="width: auto; display: flex;
                justify-content: center;
                align-items: center;">
                  تصفح العروض

                  <span class="m-c d-flex justify-content-center align-items-center rounded-5 bg-white"
                    style="margin-right: 8px;width:25px; height: 25px">{{ itemPage.count_offer }}</span>
                </router-link>
              </div>
              <div v-if="!isOwner">
                <div class="border border-2 col-12 text-center p-2 rounded-2" v-if="is_offer_sent">
                  ...
                  <div>
                    <ValidationObserver tag="div" class="position-relative" ref="form">
                      ...
                      <div class="col-12 text-center" style="height: auto">
                        <button @click="sendOffer" class="btn btn-main h-100 w-100 fs-5 p-3" type="submit" role="button">
                          أعرض خدمتك
                      ...
                      <!-- <d-overlays-simple /> -->
                      <h3 class="m-c p-2" v-if="sending">
                        أضف عرضك
                      </h3>
                      <ValidationProvider v-if="sending" :name="$t('your-offer')" vid="note" tag="div" rules="required"
                        v-slot="{ errors }">
                      ...
                      <div class="col-md-4 w-100">
                        <ValidationProvider v-if="sending" :name="$t('attachment')" vid="file" rules=""
                          v-slot="{ errors }">
