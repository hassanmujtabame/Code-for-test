<template>
  <div class="main-top py-2  position-relative" :class="{'px-5':!isMobile,'px-3':isMobile}">
        <div class="row align-items-center text-center m-auto">
            ...
            <div class="col-md-6  mt-4">
                <h2 class="text-white" :class="{'fs-1':!isMobile,'fs-6':isMobile}">
                ...
                <div class="mt-4">
                    <a href="">
                        <img :class="{'h-40px':isMobile}" :src="`${publicPath}assets/img/34-349265_app-store-google-play-svg 3.png`" alt="">
                    </a>
                    <a href="">
                        <img :class="{'h-40px':isMobile}" :src="`${publicPath}assets/img/34-349265_app-store-google-play-svg 1.png`" alt="">
                    </a>
                </div>
