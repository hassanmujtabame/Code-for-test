                        ...
                        <div class="box border-bottom">
                            ...
                            <div class="d-flex align-items-center justify-content-between  m-0 p-2">
                                    <div class="d-flex align-items-center ">
                                        <div>
                                            <img class="rounded-circle" src="/assets/img/صورة واتساب بتاريخ 2022-10-18 في 09.53.21.jpg" alt="" width="48 " height="48">
                                        </div>
                                    ...
                                    <div>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <span>
                                                <i class="fa-solid fa-star active fs-6"></i>
                                            </span>
                                            <span>
                                                <i class="fa-solid fa-star active fs-6"></i>
                                            </span>
                            ...
                            <div>
                                <p class="t-c px-2">
                                    مصمم  مميز  و متفاهم   صمم لي ما اريده و كان  سريع  في الرد علي و شغله  ممبز
                                </p>
                            </div>
                        </div>
                        <div class="box border-bottom">
