  ...
  <div>
    ...
    <div v-if="false" class="box info border p-3">
      <div class="main-img text-center m-auto">
        <img
          class="rounded-circle img-person"
          :src="userPage.image"
          :alt="userPage.name"
          width="140"
          height="140"
      ...
      <div class="text-center">
        ...
        <div class="message-service">
          <button class="text-white border-0 p-2 px-3" @click="sendMessage">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
    ...
    <div class="box border mt-3">
      <div>
        <h3 class="border-bottom p-2">تقيم الخدمه</h3>
      </div>
      <div v-if="items && items.length > 0">
        <div v-for="(item, i) in items" :key="i" class="box border-bottom">
          <div
            class="d-flex align-items-center justify-content-between m-0 p-2"
          >
    ...
    <button
      @click="save($event)"
      type="button"
      class="btn btn-main w-100 rounded-3 mt-5"
    >
      طلب خدمة مشابهة
    </button>
