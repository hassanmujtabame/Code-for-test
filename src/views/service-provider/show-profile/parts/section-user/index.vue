<template>
    <div>
            ...
            <button @click="openChat" class="text-white  border-0 px-2 py-1 rounded-3  px-3 mb-3 "
                ...
                <svg width="24" height="24" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g opacity="0.5">
                        ...
                        <path d="M8.52148 9.89844H18.1627M8.52148 14.1165H15.1498" stroke="white" stroke-width="1.5"
        ...
        <button @click="save($event)" type="button" class="btn btn-main w-100 rounded-3 mt-5">طلب خدمة مشابهة</button>
