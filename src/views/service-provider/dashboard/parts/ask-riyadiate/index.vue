  ...
  <div class="row mt-5 p-3 rounded-4" style="background:rgba(245, 245, 245, 1);">
    <div class="col-md-8 col-12 d-flex justify-content-between">
      <div class="col-md-6 col-12 d-flex flex-column justify-content-between">
        <h2>اسأل رياديات</h2>
        <div class=" d-flex justify-content-center align-items-center mt-5 bg-white rounded-3"
          style="width:90px; height:71px;">
          <img style=" width: 41px; height: 41px; object-fit: contain" class=""
            :src="`${publicPath}assets/svg/Vector.svg`" alt="" />
        </div>
      </div>
      <div class="col-md-6 col-12 d-flex flex-column justify-content-between">
        ...
        <div class=" d-flex justify-content-center align-items-center mt-5 bg-white rounded-3"
          style="width:90px; height:71px;">
          <img style="width:41px; height:41px; object-fit: contain" class="" :src="`${publicPath}assets/svg/Vector1.svg`"
            alt="" />
        </div>
      </div>
    </div>
    <div style="display: flex; justify-content: end;" class="col-md-4 col-12">
      <img style="width:233px; height:203px; object-fit: contain" class="" :src="`${publicPath}assets/svg/bro.svg`"
        alt="" />
    </div>
