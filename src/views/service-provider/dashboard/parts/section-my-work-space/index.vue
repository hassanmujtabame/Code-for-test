        ...
        <div class="row flex-column mt-3 gap-4">
          <div class="col-md-12 border p-3">
            <div class="p-3">
              ...
              <img @click="openDialog" style="cursor: pointer ; height:40px; width153px; margin-right: auto;"
                class="d-flex " :src="`${publicPath}assets/svg/Group 1171276111.svg`" />
            </div>
            <div class="px-3" style="height:300px; overflow-y: scroll;">

              <workSpaces v-for="(item, i) in workSpaces" :key="i" class="my-3" :name="item.title" :image="item.image_path"
                :comment="item.description" :price="item.price" :area="item.area" :rate="item.rate"
