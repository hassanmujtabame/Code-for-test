        ...
        <div class="d-flex align-items-center gap-4">
          <div>
            ...
            >
              ...
              />
              <path
                d="M31.966 15L36.104 22.1045L44.1395 23.8446L38.6615 29.9755L39.4897 38.1554L31.966 34.84L24.4424 38.1554L25.2706 29.9755L19.7925 23.8446L27.828 22.1045L31.966 15Z"
                fill="#FFBC00"
              />
            </svg>
          </div>
          <div class="d-flex flex-column justify-content-center gap-1">
            <h3 style="color: #ffbc00">تقييم خدماتي</h3>
            <button
    ...
    <div class="p-3 col-md-6 col-12">
      ...
      >
        <div class="d-flex align-items-center gap-4">
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.21"
              />
              <g clip-path="url(#clip0_3580_12227)">
                <path
                ...
                />
                <path
                  d="M34.7032 25.9734C35.9048 25.1606 37.3322 24.7226 38.8293 24.7226C39.6959 24.7226 40.5389 24.8698 41.3286 25.1509V23.6869H17.582V25.9734H34.7032Z"
                  fill="#F2631C"
                />
                <path
                  d="M44.4724 31.7017C44.4724 28.6886 41.9461 26.2461 38.8299 26.2461C35.7137 26.2461 33.1875 28.6886 33.1875 31.7017C33.1875 34.7149 35.7137 37.1574 38.8299 37.1574C41.9461 37.1574 44.4724 34.7149 44.4724 31.7017ZM39.5905 34.6163V35.2363H38.8027V35.2364V35.2363H38.0149V34.6209C37.5386 34.465 37.149 34.1906 36.7684 33.9215L37.6985 32.6918C38.2098 33.0534 38.4714 33.2272 38.8299 33.2272C39.0327 33.2272 39.1968 33.1339 39.2583 32.9837C39.3328 32.8019 39.2276 32.6344 38.9766 32.5357C38.9766 32.5357 37.8506 32.1725 37.3299 31.6593C36.8931 31.2288 36.7542 30.6219 36.8932 30.0447C37.0333 29.4635 37.4391 29.0091 38.0149 28.7821V28.1671H39.5905V28.7566C39.9907 28.8641 40.3293 29.0229 40.5241 29.1251L39.7724 30.464C39.274 30.2024 38.8155 30.1239 38.637 30.1829C38.4639 30.2401 38.4376 30.3492 38.4276 30.3904C38.4136 30.4486 38.4061 30.538 38.5024 30.6418C38.5951 30.7417 39.5707 31.1247 39.5707 31.1247C40.6232 31.539 41.1186 32.5795 40.723 33.5449C40.5175 34.0467 40.1039 34.4267 39.5905 34.6163Z"
                  fill="#F2631C"
                />
              </g>
              <defs>
                <clipPath id="clip0_3580_12227">
                  <rect
                    width="26.8897"
                    height="26"
                    fill="white"
          ...
          <div class="d-flex flex-column justify-content-center gap-1">
            <h3 style="color: #f2631c">خدمة مكتملة</h3>
            <button
              @click="router_push('service-provider-rate-my-service')"
              style="
                color: #888;
    ...
    <div class="p-3 col-md-6 col-12">
      ...
      >
        <div class="d-flex align-items-center gap-4">
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.19"
              />
              <g clip-path="url(#clip0_3580_12206)">
                <path
                  d="M41.3286 22.1634V21.8077C41.3286 20.1727 39.9529 18.8425 38.2619 18.8425H20.6487C18.9577 18.8426 17.582 20.1727 17.582 21.8077V22.1634H41.3286Z"
                  fill="#2C98B3"
                />
          ...
          <div class="d-flex flex-column justify-content-center gap-1">
            <h3 style="color: #2c98b3">طلب ينتظر موفقتك</h3>
            <button
              @click="router_push('service-provider-rate-my-service')"
              style="
                color: #888;
    ...
    <div class="p-3 col-md-6 col-12">
      ...
      >
        <div class="d-flex align-items-center gap-4">
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.19"
              />
              <g clip-path="url(#clip0_3580_12270)">
                <path
                  d="M41.3286 22.1634V21.8077C41.3286 20.1727 39.9529 18.8425 38.2619 18.8425H20.6487C18.9577 18.8426 17.582 20.1727 17.582 21.8077V22.1634H41.3286Z"
                  fill="#1FB9B3"
                />
                ...
                />
                <path
                  d="M44.4724 31.7017C44.4724 28.6886 41.9461 26.246 38.8299 26.246C35.7137 26.246 33.1875 28.6886 33.1875 31.7017C33.1875 34.7148 35.7137 37.1574 38.8299 37.1574C41.9461 37.1574 44.4724 34.7148 44.4724 31.7017ZM39.5905 34.6163V35.2363H38.8027V35.2364V35.2363H38.0149V34.6209C37.5386 34.4649 37.149 34.1906 36.7684 33.9215L37.6985 32.6918C38.2098 33.0534 38.4714 33.2272 38.8299 33.2272C39.0327 33.2272 39.1968 33.1339 39.2583 32.9837C39.3328 32.8019 39.2276 32.6344 38.9766 32.5357C38.9766 32.5357 37.8506 32.1725 37.3299 31.6593C36.8931 31.2288 36.7542 30.6219 36.8932 30.0447C37.0333 29.4635 37.4391 29.0091 38.0149 28.7821V28.1671H39.5905V28.7566C39.9907 28.8641 40.3293 29.0229 40.5241 29.1251L39.7724 30.4639C39.274 30.2024 38.8155 30.1239 38.637 30.1829C38.4639 30.24 38.4376 30.3492 38.4276 30.3904C38.4136 30.4486 38.4061 30.538 38.5024 30.6418C38.5951 30.7417 39.5707 31.1247 39.5707 31.1247C40.6232 31.539 41.1186 32.5795 40.723 33.5449C40.5175 34.0467 40.1039 34.4267 39.5905 34.6163Z"
                  fill="#1FB9B3"
                />
              </g>
              <defs>
                <clipPath id="clip0_3580_12270">
                  <rect
                    width="26.8897"
                    height="26"
                    fill="white"
          ...
          <div class="d-flex flex-column justify-content-center gap-1">
            <h3 style="color: #1fb9b3">خدمة قيد التنفيذ</h3>
            <button
              @click="router_push('service-provider-rate-my-service')"
              style="
                color: #888;
          ...
          <div>
            ...
            >
              <rect
                ...
                fill-opacity="0.19"
              />
              <g clip-path="url(#clip0_3580_12249)">
                <path
                  d="M41.3286 22.1634V21.8077C41.3286 20.1727 39.9529 18.8425 38.2619 18.8425H20.6487C18.9577 18.8426 17.582 20.1727 17.582 21.8077V22.1634H41.3286Z"
                  fill="#FFBC00"
                />
          ...
          >
            <div class="d-flex gap-3 align-items-center">
              ...
              <div class="d-flex flex-column justify-content-center gap-1">
                ...
                width1200px    outline: 1px solid #888;
                  "
                >
                  عرض الكل
                </button>
