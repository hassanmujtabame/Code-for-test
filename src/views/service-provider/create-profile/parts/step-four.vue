<template>
    <div>
        <ValidationObserver>
            ...
            <ValidationProvider vid="هل لديك رابط بورتفوليو خارجي؟" rules="required" :name="'هل لديك رابط بورتفوليو خارجي؟'"
                v-slot="{ errors }" tag="div" class="mb-3">
                <b-form-input type="text" :placeholder="'هل لديك رابط بورتفوليو خارجي؟'" required />
