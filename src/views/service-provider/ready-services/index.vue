...
يمكنك أضافة خدماتك و ما يمكنك تقديمه الى العملاء كخدمات جاهزة يمكنهم طلب شرائها منك</p>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div style="  line-height: 2.5; height: 40px;"
                    class=" col-12 col-md-5 mt-3 btn-main btn-nav text-center">
                    <a href="" class="text-white " data-bs-toggle="modal" data-bs-target="#addModal">أضف خدمة جديدة</a>
                </div>
