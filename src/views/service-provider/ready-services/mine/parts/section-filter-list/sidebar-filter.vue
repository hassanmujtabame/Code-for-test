<template>
  <div class="box">
    <p class="p-2 m-0 border-bottom w-75">
      <svg
        width="32"
        height="32"
        viewBox="0 0 32 32"
      ...
      <div class="accordion-item mb-4">
        ...
        >
          <div class="accordion-body">
            <div class="d-flex flex-wrap rounded-3" style="">
              <div
                v-for="(state, i) in states"
                :key="i"
                class="form-check text-center form-check-custom-states"
                style="border: 1px solid #1fb9b3; width: 200px"
              >
                <input
                ...
                <label
                  ...
                  :id="state.id"
                  class="form-check-label t form-check-custom"
                  :for="state.id"
                  >{{ state.name }}</label
                >
              </div>
