<template>
  <div class="mt-5 blog">
    <d-filter-list :call-list="loadList" @change="changeFilter" :searchPlaceholder="$t('search_by_service')"
      orderName="price" newFilter hideTitle showBtnSearch :orderOpts="[
        { id: 'asc', name: 'الأقل سعرا' },
        { id: 'desc', name: 'الأغلى سعرا', }
      ]" classColCard="col-lg-4 mt-3" classSideBar="w-100" classSearchOrder="col-md-9 flex-direction"
      classColOrder="col-12 col-md-3" classColSearch="col-12 col-md-7" classTotal="col-md-3">
