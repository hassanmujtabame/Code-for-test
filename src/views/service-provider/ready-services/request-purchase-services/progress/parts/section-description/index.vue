<template>
   <div class="box border rounded-3 ">
                            <div class="t-c ">
                                ...
                                <h4 class="title-section border-bottom p-2 fs-r-24-40">
                                    وصف  الخدمة الخاصة بك
                                </h4>
                                <p class="p-2" v-html="readyService.desc">
                                   </p>
                            </div>
                            <div>
                                <h3 class="title-section border-bottom p-2 fs-r-24-40">
                                    تفاصيل  الخدمة 
                                </h3>
                                <div class="row p-2">
                                    <div class="col-6 p-2">
                                    ...
                                    <div class="col-6 p-2">
                                        ...
                                        <span class="m-c">
                                            {{readyService.implementation_period}} ايام
                                        </span>
                                    ...
                                    <div class="col-md-auto p-2">
                                        ...
                                        <span class="m-c">
                                            {{ readyService.delivery_place?$t(readyService.delivery_place):'N/A' }}
                                        </span>
                            ...
                            <div class="p-2 text-center">
                                ...
                                <span class="m-c fw-bolder">
                                    {{dateReverse(readyService.created_at)}}
                                </span>
                            </div>
                        </div>
</template>
