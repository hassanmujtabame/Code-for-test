   ...
   <div class="box border rounded-3 p-4 ">
    ...
    لدي خبرة كبيرة في مجال التصميم و مرفق بعض من اعمالي فقط تواصلي معي واخبريني ماذا تفضلين و نبدأ بالتنفيذ فورا
                            ...
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 p-2">
                                        ...
                                        <span class="m-c">
                                            {{itemPage.implementation_period}} ايام
                                        </span>
                            ...
                            <div class="mt-4">
                                ...
                                <div v-if="itemPage.keywords" class="d-flex flex-wrap justify-content-between text-white word-intial pt-3">
                                    <p v-for="(tag,i) in itemPage.keywords.split(',')" :key="i">
                                        {{tag}}
                                    </p>
