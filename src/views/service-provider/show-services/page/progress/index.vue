  ...
  <div class="row justify-content-between">
      ...
      <div class="col-md-6 d-flex gap-2 justify-content-end">
          <div>
              ...
              <div  v-if="itemPage.user_offer && itemPage.user_offer && itemPage.user_offer.user_info.id==user.id" class="dropdown">
          ...
          <div> 
              <button v-if="itemPage.user_info.id==user.id" @click="confirmDeliveredProductMsg" style="height: 40px;" class="btn-main px-3 w-100 border-0 rounded-2"  role="button">
