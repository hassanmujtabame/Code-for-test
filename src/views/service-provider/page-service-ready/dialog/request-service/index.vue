            ...
            <div>
                ...
                <div class="p-2">
                    ...
                    <div class="d-flex">
                        ...
                        <div>
                            <label onclick="increase()" id="increase" for="number">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <input type="text" value="0" name="number" id="in-number">
                            <label onclick="decrease()" id="decrease" for="number">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M0.5 4C0.5 2.067 2.067 0.5 4 0.5H20C21.933 0.5 23.5 2.067 23.5 4V20C23.5 21.933 21.933 23.5 20 23.5H4C2.067 23.5 0.5 21.933 0.5 20V4Z"
                    ...
                    <div>
                        <textarea name="" id="" class="w-100 rounded-1 border p-2" rows="8"
