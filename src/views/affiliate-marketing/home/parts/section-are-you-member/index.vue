<template>
  ...
  >
    <div class="row align-items-center">
      ...
      <div class="box col-12 px-5 col-md-8">
        <p
        ...
        <router-link
          ...
          class="btn px-5 py-2 text-white svg-network"
        >
          <!-- <svg
            height="24"
            viewBox="0 0 24 24"
      ...
      <div
        style="align-items: start; justify-content: end"
        class="col-md-4 d-md-flex d-hidden"
      >
        <img
          style="margin-left: -14px"
          class="img-fluid"
          :src="`${publicPath}assets/svg/Frame.svg`"
          alt=""
        />
      </div>
    </div>
...
<style>
.main-bg {
  background: linear-gradient(to left, #1e817d, #1fb9b3);
}
</style>
