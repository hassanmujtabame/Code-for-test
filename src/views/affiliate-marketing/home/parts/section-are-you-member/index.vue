<template>
   <div class="main-top py-2 position-relative mt-5 container-fluid" style="border-radius: 10px;;" :class="{'px-5':!isMobile,'px-3':isMobile}">
            <div class="row align-items-center m-auto">
                ...
                <div class="box col-12 col-md-8" >
                    ...
                    <p class="text-white fs-r-24" :class="{'w-75':!isMobile,'w-100':isMobile}">
                        إذا كنتى عضوة بالفعل فى أحد خدمات رياديات الان يمكنك بدا رحلتك فى التسويق بالعمولة من خلال منصة رياديات وأطلقى متجرك الإلكترونى الخاص  </p>
