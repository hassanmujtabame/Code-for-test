...
const routers = [
  ...
  {
    path: "academy/category/:id(\\d+)",
    meta: { layout: LayoutDefault, title: "academy category" },
    name: "academy-category",
    component: () =>
      import(
        /* webpackChunkName: "academy-department-courses" */ "../views/academy/category-page/category-page.vue"
      ),
  },
  {
